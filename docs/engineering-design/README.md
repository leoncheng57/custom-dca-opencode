...
| [Session Todo — Placement Alternatives and Progress Affordance — 2026-08-28](https://app.notion.com/p/Session-Todo-Placement-Alternatives-and-Progress-Affordance-2026-08-28-3caa232837d98107ac99cacf767718db) | 2026-08-28 | Ten placement candidates for the session todo list and a progress ring, plus the pull-based refresh path and the `PLAN_TOOL_ALLOWLIST` reason Plan mode may write todos. Proposed, not implemented. | Private until manually published |
