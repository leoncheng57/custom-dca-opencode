import{c as B,b as N,r as f,d as z,D as W,e as G,j as a,A as H,S as V,L as K}from"./index-CAQDY1QE.js";/**
 * @license lucide-react v1.33.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Y=[["path",{d:"m7 11 2-2-2-2",key:"1lz0vl"}],["path",{d:"M11 13h4",key:"1p7l4v"}],["rect",{width:"18",height:"18",x:"3",y:"3",rx:"2",ry:"2",key:"1m3agn"}]],X=B("square-terminal",Y),Q=/^([|>])([+-]?)(\d*)([+-]?)$/,E=/^(\s*)([A-Za-z0-9_.-]+)\s*:\s?(.*)$/,A=/^(\s*)-\s+(.*)$/;function v(e){return e.length-e.trimStart().length}function k(e,n){if(e.length<2||!e.startsWith(n)||!e.endsWith(n))return!1;const t=e.slice(1,-1);if(n==="'"){for(let s=0;s<t.length;s+=1)if(t[s]==="'"){if(t[s+1]==="'"){s+=1;continue}return!1}return!0}for(let s=0;s<t.length;s+=1){if(t[s]==="\\"){s+=1;continue}if(t[s]==='"')return!1}return!0}function P(e){return k(e,'"')?e.slice(1,-1).replace(/\\(["\\])/g,"$1"):k(e,"'")?e.slice(1,-1).replace(/''/g,"'"):e}function j(e){if(e.startsWith('"')||e.startsWith("'"))return e;const n=e.search(/(^|\s)#/);return n===-1?e:e.slice(0,n)}function C(e){const n=j(e.trim()).trim();return P(n)}function J(e){const n=j(e.trim()).trim();if(k(n,'"')||k(n,"'"))return P(n);if(n==="true")return!0;if(n==="false")return!1;if(n!==""){const t=Number(n);if(!Number.isNaN(t))return t}return n}function Z(e){let n="",t=0;for(const s of e){if(s===""){t+=1;continue}n===""?n=s:(n+=t>0?`
`.repeat(t):" ",n+=s),t=0}return n}function ee(e,n,t){return t==="strip"?e:t==="keep"?e+`
`.repeat(n+1):e===""?"":`${e}
`}function ne(e,n,t,s,r){const h=[];let o=n;for(;o+1<e.length;){const u=e[o+1];if(u.trim()===""){h.push(""),o+=1;continue}if(v(u)<=t)break;h.push(u),o+=1}let c=h.length-1;for(;c>=0&&h[c]==="";)c-=1;const d=h.length-1-c,l=h.slice(0,c+1),p=l.reduce((u,m)=>m===""?u:Math.min(u,v(m)),Number.MAX_SAFE_INTEGER),b=l.map(u=>u===""?"":u.slice(Math.min(p,v(u)))),w=s==="|"?b.join(`
`):Z(b);return{value:ee(w,d,r),endIndex:o}}function te(e){const n=e[2]||e[4];return n==="-"?"strip":n==="+"?"keep":"clip"}function ae(e,n){for(let t=n+1;t<e.length;t+=1){const s=e[t];if(!(s.trim()===""||s.trimStart().startsWith("#")))return s}}function se(e){return e.replace(/^\uFEFF/,"").replace(/\r\n?/g,`
`)}function q(e){const n=se(e);if(!/^---[ \t]*(\n|$)/.test(n))return{data:{},content:n};const t=n.split(`
`);let s=-1;for(let l=1;l<t.length;l+=1){const p=t[l];if(p==="---"||p==="..."||/^(---|\.\.\.)[ \t]+$/.test(p)){s=l;break}}if(s===-1)return{data:{},content:n};const r=t.slice(1,s),h=t.slice(s+1).join(`
`),o={};let c=null,d=null;for(let l=0;l<r.length;l+=1){const p=r[l];if(p.trim()===""||p.trimStart().startsWith("#"))continue;const b=p.match(A);if(b&&c){const g=o[c];Array.isArray(g)&&g.push(C(b[2]));continue}const w=p.match(E);if(!w){c=null,d=null;continue}const[,u,m,_]=w,y=u.length>0;if(y&&!d)continue;y||(d=null,c=null);const S=_.trim(),x=S.match(Q);if(x){const{value:g,endIndex:L}=ne(r,l,u.length,x[1],te(x));l=L,y&&d?o[d][m]=g:o[m]=g;continue}if(S===""){const g=ae(r,l);if(g&&A.test(g)&&v(g)>=u.length){o[m]=[],c=m,d=null;continue}if(g&&v(g)>u.length&&E.test(g)){o[m]={},d=m,c=null;continue}y&&d?o[d][m]="":o[m]="";continue}if(y&&d){o[d][m]=C(_);continue}o[m]=J(_),c=null}return{data:o,content:h}}function ie(e){return e.replace(/^\s*#\s+.+?(\n+|$)/,"")}const oe=/\$ARGUMENTS\b|\$[1-9]\b/,re=/!`[^`]+`/;function O(e){return/^[a-z0-9]+(?:-[a-z0-9]+)*$/.test(e)}function de(e,n){return e<n?-1:e>n?1:0}function $(e){const n=e.split("/").filter(Boolean).pop()??"";return n.endsWith(".md")?n.slice(0,-3):""}function ce(e,n){return n?`/${e} <arguments>`:`/${e}`}function le(e,n,t={}){const s=$(e);if(!O(s))return null;const{data:r,content:h}=q(n),o=h.trim(),c=(r.description??"").trim();return o===""?null:{name:s,description:c,agent:r.agent,model:r.model,subtask:r.subtask===!0,body:o,takesArguments:oe.test(o),runsShell:re.test(o),...t.simulation?{simulation:t.simulation}:{},bytes:typeof TextEncoder>"u"?n.length:new TextEncoder().encode(n).length}}function he(e,n={}){return Object.entries(e).map(([t,s])=>{var r;return le(t,s,{simulation:(r=n.simulations)==null?void 0:r.get($(t))})}).filter(t=>t!==null).sort((t,s)=>de(t.name,s.name))}function ue(e,n){const t=n.trim().toLowerCase();return t===""?e:e.filter(s=>[s.name,s.description,s.body].join(" ").toLowerCase().includes(t))}const pe="leoncheng57",me="custom-dca-opencode",U=`${pe}/${me}`,ge=`https://github.com/${U}`,I="agent-skills",fe="main";function Xt(e){if(!O(e))throw new Error(`Invalid command name: ${e}`);const n=`https://raw.githubusercontent.com/${U}/${fe}/${I}/commands/${e}.md`;return[{id:"curl-global",label:"curl",scope:"global",note:"Recommended. Available in every project you open with OpenCode.",command:["mkdir -p ~/.config/opencode/commands && \\",`curl -sL ${n} \\`,`  -o ~/.config/opencode/commands/${e}.md`].join(`
...
`)},{id:"symlink",label:"clone + symlink",scope:"global",note:"Stays updatable: git pull in the clone refreshes the live command.",command:[`git clone ${ge}.git ~/src/custom-dca-opencode   # once`,"mkdir -p ~/.config/opencode/commands",`ln -s ~/src/custom-dca-opencode/${I}/commands/${e}.md \\`,`      ~/.config/opencode/commands/${e}.md`].join(`
`)}]}const be=[{path:"~/.config/opencode/commands/<name>.md",scope:"Global",readBy:"OpenCode",note:"Every project. Start here."},{path:".opencode/commands/<name>.md",scope:"Project",readBy:"OpenCode",note:"Committed with the repo; loads only inside it."},{path:".claude/commands/<name>.md",scope:"Project",readBy:"Claude Code",note:"Different frontmatter dialect (argument-hint, allowed-tools). Not shipped here."}],ye=`---
...
`,hn=["user","assistant","tool","note"],un=/^##[ \t]+([a-z]+)(?:[ \t]+—[ \t]*(.*))?[ \t]*$/,pn=/^[ \t]{0,3}(`{3,}|~{3,})(.*)$/;function mn(e){return hn.includes(e)}function gn(e){const n=[];let t=null,s=null;for(const r of e.split(`
`)){const h=r.match(pn);if(h){const[,c,d]=h;s===null?s=c:c[0]===s[0]&&c.length>=s.length&&d.trim()===""&&(s=null),t==null||t.lines.push(r);continue}const o=s===null?r.match(un):null;if(o){const[,c,d]=o;if(!mn(c))return null;t={role:c,label:(d==null?void 0:d.trim())||void 0,lines:[]},n.push(t);continue}if(t){t.lines.push(r);continue}if(r.trim()!=="")return null}return n}function fn(e){const{data:n,content:t}=q(e),s=(n.title??"").trim(),r=(n.trigger??"").trim(),h=(n.caveat??"").trim();if(s===""||r===""||h==="")return null;const o=gn(ie(t));if(o===null||o.length===0||o[0].role!=="user")return null;const c=o.map(d=>({...d,body:d.lines.join(`
`).trim()})).filter(d=>d.body!=="").map(({role:d,label:l,body:p})=>l===void 0?{role:d,body:p}:{role:d,label:l,body:p});return c.length===0?null:{title:s,trigger:r,caveat:h,turns:c}}function bn(e){const n=new Map;for(const[t,s]of Object.entries(e)){const r=t.split("/").filter(Boolean),h=r.length>1?r.at(-2)??"":"",o=h===""?null:fn(s);o&&n.set(h,o)}return n}const yn=Object.assign({"../../agent-skills/commands/background.md":ye,"../../agent-skills/commands/build-waves.md":ve,"../../agent-skills/commands/cite-file-lines.md":we,"../../agent-skills/commands/dca.md":ke,"../../agent-skills/commands/deep-research.md":_e,"../../agent-skills/commands/diagram.md":xe,"../../agent-skills/commands/docs-preview.md":Te,"../../agent-skills/commands/duck-mode.md":Re,"../../agent-skills/commands/goal.md":Se,"../../agent-skills/commands/grill-me.md":Ee,"../../agent-skills/commands/handoff.md":Ae,"../../agent-skills/commands/leaving-now-wrap-up.md":Ce,"../../agent-skills/commands/manager-children.md":Ie,"../../agent-skills/commands/mini-design-doc.md":De,"../../agent-skills/commands/native-worktree-subagents.md":Ne,"../../agent-skills/commands/red-team.md":Pe,"../../agent-skills/commands/research-handoff.md":je,"../../agent-skills/commands/review-learning.md":qe,"../../agent-skills/commands/session-handoff.md":Oe,"../../agent-skills/commands/standup.md":$e,"../../agent-skills/commands/system-design-artifacts.md":Ue,"../../agent-skills/commands/verify.md":Fe,"../../agent-skills/commands/worktree-up.md":Me}),vn=Object.assign({"../../agent-skills/command-simulations/background.md":Le,"../../agent-skills/command-simulations/build-waves.md":Be,"../../agent-skills/command-simulations/cite-file-lines.md":ze,"../../agent-skills/command-simulations/dca.md":We,"../../agent-skills/command-simulations/deep-research.md":Ge,"../../agent-skills/command-simulations/diagram.md":He,"../../agent-skills/command-simulations/docs-preview.md":Ve,"../../agent-skills/command-simulations/duck-mode.md":Ke,"../../agent-skills/command-simulations/goal.md":Ye,"../../agent-skills/command-simulations/grill-me.md":Xe,"../../agent-skills/command-simulations/handoff.md":Qe,"../../agent-skills/command-simulations/leaving-now-wrap-up.md":Je,"../../agent-skills/command-simulations/manager-children.md":Ze,"../../agent-skills/command-simulations/mini-design-doc.md":en,"../../agent-skills/command-simulations/native-worktree-subagents.md":nn,"../../agent-skills/command-simulations/red-team.md":tn,"../../agent-skills/command-simulations/research-handoff.md":an,"../../agent-skills/command-simulations/review-learning.md":sn,"../../agent-skills/command-simulations/session-handoff.md":on,"../../agent-skills/command-simulations/standup.md":rn,"../../agent-skills/command-simulations/system-design-artifacts.md":dn,"../../agent-skills/command-simulations/verify.md":cn,"../../agent-skills/command-simulations/worktree-up.md":ln});function wn(e){return Object.fromEntries(Object.entries(e).map(([n,t])=>{var r;return[`commands/${((r=n.split("/").pop())==null?void 0:r.replace(/\.md$/u,""))??""}/SIMULATION.md`,t]}))}const R=he(yn,{simulations:bn(wn(vn))});function Qt(e){return R.find(n=>n.name===e)}const kn="https://github.com/leoncheng57/custom-dca-opencode",_n="main",D=`${kn}/blob/${_n}/agent-skills`,Jt={command:e=>`${D}/commands/${e}.md`,commandSimulation:e=>`${D}/command-simulations/${e}.md`},F={status:"unknown",directoryLabel:"",installedCommands:new Set},T=F;function xn(e){const n=e.replace(/\/+$/u,"");return n.slice(n.lastIndexOf("/")+1)||n}function Tn(e,n){return!e||!n?F:{status:"ready",directoryLabel:xn(e),installedCommands:new Set(n.commands.map(t=>t.name))}}function Rn(){const e=N(),[n,t]=f.useState(T);return f.useEffect(()=>{const s=z(e.search,typeof localStorage>"u"?null:localStorage.getItem(W));if(!s){t(T);return}const r=new AbortController;let h=!1;return G.catalog(s,r.signal).then(o=>{h||t(Tn(s,o))}).catch(()=>{h||t(T)}),()=>{h=!0,r.abort()}},[e.search]),n}const Sn="_page_khz9n_1",En="_content_khz9n_8",An="_wipWarning_khz9n_14",Cn="_eyebrow_khz9n_16",In="_type_khz9n_16",Dn="_filterLabel_khz9n_16",Nn="_filterInput_khz9n_16",Pn="_meta_khz9n_16",jn="_source_khz9n_16",qn="_terminal_khz9n_16",On="_methodScope_khz9n_16",$n="_hero_khz9n_20",Un="_modalTitle_khz9n_37",Fn="_cardTitle_khz9n_37",Mn="_sectionTitle_khz9n_37",Ln="_lede_khz9n_42",Bn="_typeStats_khz9n_44",zn="_typeStat_khz9n_44",Wn="_catalog_khz9n_49",Gn="_catalogHead_khz9n_50",Hn="_filter_khz9n_16",Vn="_clear_khz9n_56",Kn="_cardLink_khz9n_57",Yn="_grid_khz9n_60",Xn="_card_khz9n_37",Qn="_cardTop_khz9n_62",Jn="_typeCommand_khz9n_63",Zn="_loadState_khz9n_66",et="_loadStateOn_khz9n_67",nt="_loadStateOff_khz9n_68",tt="_scopeNote_khz9n_69",at="_cardCommand_khz9n_70",st="_cardCopy_khz9n_71",it="_cardTags_khz9n_71",ot="_empty_khz9n_72",rt="_locations_khz9n_74",dt="_tableWrap_khz9n_74",ct="_table_khz9n_74",lt="_dialog_khz9n_76",ht="_dialogBody_khz9n_77",ut="_close_khz9n_77",pt="_modalHead_khz9n_78",mt="_modalDescription_khz9n_78",gt="_route_khz9n_78",ft="_detailGrid_khz9n_79",bt="_side_khz9n_79",yt="_terminalBar_khz9n_81",vt="_light_khz9n_81",wt="_terminalPath_khz9n_81",kt="_terminalSource_khz9n_81",_t="_terminalTurns_khz9n_81",xt="_turn_khz9n_81",Tt="_turnRole_khz9n_81",Rt="_turnAssistant_khz9n_81",St="_turnTool_khz9n_81",Et="_turnNote_khz9n_81",At="_terminalControls_khz9n_85",Ct="_terminalButton_khz9n_85",It="_terminalButtonPrimary_khz9n_85",Dt="_terminalStatus_khz9n_85",Nt="_progress_khz9n_85",Pt="_terminalCaveat_khz9n_85",jt="_disclosures_khz9n_87",qt="_disclosure_khz9n_87",Ot="_disclosureMeta_khz9n_87",$t="_disclosureBody_khz9n_87",Ut="_descriptionPanel_khz9n_87",Ft="_descriptionBar_khz9n_87",Mt="_descriptionBody_khz9n_87",Lt="_method_khz9n_16",Bt="_methodHead_khz9n_87",zt="_methodCopy_khz9n_87",Wt="_command_khz9n_87",Gt="_notFound_khz9n_87",i={page:Sn,content:En,wipWarning:An,eyebrow:Cn,type:In,filterLabel:Dn,filterInput:Nn,meta:Pn,source:jn,terminal:qn,methodScope:On,hero:$n,modalTitle:Un,cardTitle:Fn,sectionTitle:Mn,lede:Ln,typeStats:Bn,typeStat:zn,catalog:Wn,catalogHead:Gn,filter:Hn,clear:Vn,cardLink:Kn,grid:Yn,card:Xn,cardTop:Qn,typeCommand:Jn,loadState:Zn,loadStateOn:et,loadStateOff:nt,scopeNote:tt,cardCommand:at,cardCopy:st,cardTags:it,empty:ot,locations:rt,tableWrap:dt,table:ct,dialog:lt,dialogBody:ht,close:ut,modalHead:pt,modalDescription:mt,route:gt,detailGrid:ft,side:bt,terminalBar:yt,light:vt,terminalPath:wt,terminalSource:kt,terminalTurns:_t,turn:xt,turnRole:Tt,turnAssistant:Rt,turnTool:St,turnNote:Et,terminalControls:At,terminalButton:Ct,terminalButtonPrimary:It,terminalStatus:Dt,progress:Nt,terminalCaveat:Pt,disclosures:jt,disclosure:qt,disclosureMeta:Ot,disclosureBody:$t,descriptionPanel:Ut,descriptionBar:Ft,descriptionBody:Mt,method:Lt,methodHead:Bt,methodCopy:zt,command:Wt,notFound:Gt};function M({install:e,installed:n}){return e.status!=="ready"?null:a.jsxs("span",{className:`${i.loadState} ${n?i.loadStateOn:i.loadStateOff}`,"data-installed":n,"data-testid":"opencode-playbook-command-load-state",title:`Reported by the OpenCode server for ${e.directoryLabel}. Installation is per project.`,children:[n?"Loaded":"Not loaded"," in ",e.directoryLabel]})}function Ht({command:e,install:n}){return a.jsxs("article",{className:`${i.card} ${i.cardCommand}`,"data-playbook-kind":"command","data-testid":"opencode-playbook-command-card",children:[a.jsxs("div",{className:i.cardTop,children:[a.jsxs("span",{className:`${i.type} ${i.typeCommand}`,children:[a.jsx(X,{"aria-hidden":"true",size:10})," Command · human-invoked"]}),a.jsx("span",{className:i.meta,children:e.subtask?"subtask":"session"})]}),a.jsx(M,{install:n,installed:n.installedCommands.has(e.name)}),a.jsx("h2",{className:i.cardTitle,children:ce(e.name,e.takesArguments)}),a.jsx("p",{className:i.cardCopy,children:e.description}),a.jsxs("div",{className:i.cardTags,children:[e.runsShell&&a.jsx("span",{children:"shell input"}),e.agent&&a.jsx("span",{children:e.agent})]}),a.jsx(K,{className:i.cardLink,"data-testid":`opencode-playbook-command-${e.name}`,to:`/playbooks/commands/${e.name}`,children:"Read command →"})]})}function Vt(){return a.jsxs("section",{className:i.locations,"aria-labelledby":"command-locations-heading",children:[a.jsx("div",{className:i.eyebrow,children:"Install locations"}),a.jsx("h2",{className:i.sectionTitle,id:"command-locations-heading",children:"Where commands live"}),a.jsx("p",{children:"Commands are individual OpenCode Markdown files. They add zero retrieval context until a human explicitly invokes one."}),a.jsx("div",{className:i.tableWrap,children:a.jsxs("table",{className:i.table,children:[a.jsx("thead",{children:a.jsxs("tr",{children:[a.jsx("th",{scope:"col",children:"Path"}),a.jsx("th",{scope:"col",children:"Scope"}),a.jsx("th",{scope:"col",children:"Read by"})]})}),a.jsx("tbody",{children:be.map(e=>a.jsxs("tr",{children:[a.jsx("th",{scope:"row",children:e.path}),a.jsx("td",{children:e.scope}),a.jsxs("td",{children:[e.readBy,a.jsx("span",{children:e.note})]})]},e.path))})]})})]})}function Kt({detail:e}){var d;const[n,t]=f.useState(""),s=f.useRef(null),r=f.useRef(null),h=((d=N().state)==null?void 0:d.focusCatalog)===!0;f.useEffect(()=>{var l;h&&((l=r.current)==null||l.focus())},[h]);const o=Rn(),c=f.useMemo(()=>ue(R,n),[n]);return a.jsxs("main",{className:i.page,"data-testid":"opencode-playbooks",ref:r,tabIndex:-1,children:[a.jsxs("div",{className:i.content,children:[a.jsx(H,{className:i.wipWarning,"data-testid":"opencode-playbooks-wip-warning",variant:"warning",children:"Playbooks is still work in progress and its UI/UX may contain bugs."}),a.jsxs("header",{className:i.hero,children:[a.jsxs("div",{children:[a.jsx("div",{className:i.eyebrow,children:"Repository-owned commands"}),a.jsx("h1",{children:"Repeatable work, invoked on purpose."}),a.jsx("p",{className:i.lede,children:"Each Playbook is an explicit slash command. Nothing is retrieved or added to agent context until a human invokes it; runtime reminders remain a separate per-message mechanism."})]}),a.jsxs("aside",{className:i.typeStats,"aria-label":"Playbook types",children:[a.jsxs("div",{className:i.typeStat,children:[a.jsx("strong",{children:R.length}),a.jsx("span",{children:"Commands"})]}),a.jsxs("div",{className:i.typeStat,children:[a.jsx("strong",{children:"0"}),a.jsx("span",{children:"At-rest tokens"})]})]})]}),a.jsxs("section",{className:i.catalog,"aria-labelledby":"playbook-catalog-heading",children:[a.jsxs("div",{className:i.catalogHead,children:[a.jsxs("div",{children:[a.jsx("div",{className:i.eyebrow,children:"Catalogue"}),a.jsxs("h2",{className:i.sectionTitle,id:"playbook-catalog-heading",children:[c.length," matching commands"]})]}),a.jsxs("label",{className:i.filter,children:[a.jsx(V,{"aria-hidden":"true",size:14}),a.jsx("span",{className:i.filterLabel,children:"filter"}),a.jsx("input",{className:i.filterInput,"data-testid":"opencode-playbook-filter",onChange:l=>t(l.target.value),placeholder:"name, description, or instruction",ref:s,type:"search",value:n}),n&&a.jsx("button",{"aria-label":"Clear filter",className:i.clear,"data-testid":"opencode-playbook-filter-clear",onClick:()=>{var l;t(""),(l=s.current)==null||l.focus()},type:"button",children:"×"})]})]}),c.length?a.jsx("div",{className:i.grid,children:c.map(l=>a.jsx(Ht,{command:l,install:o},l.name))}):a.jsxs("p",{className:i.empty,children:["No command matches ",a.jsx("code",{children:n.trim()}),"."]})]}),a.jsx(Vt,{})]}),e]})}const Zt=Object.freeze(Object.defineProperty({__proto__:null,InstallState:M,PlaybooksPage:Kt},Symbol.toStringTag,{value:"Module"}));export{M as I,Kt as P,_n as a,Zt as b,Xt as c,Qt as f,ce as i,Jt as p,i as s,Rn as u};
