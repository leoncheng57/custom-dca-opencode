import{c as B,b as N,r as f,d as z,D as W,e as G,j as a,A as H,S as V,L as K}from"./index-CRI5vte_.js";/**
...
`,ln=["user","assistant","tool","note"],hn=/^##[ \t]+([a-z]+)(?:[ \t]+—[ \t]*(.*))?[ \t]*$/,un=/^[ \t]{0,3}(`{3,}|~{3,})(.*)$/;function pn(e){return ln.includes(e)}function mn(e){const n=[];let t=null,s=null;for(const r of e.split(`
`)){const h=r.match(un);if(h){const[,c,d]=h;s===null?s=c:c[0]===s[0]&&c.length>=s.length&&d.trim()===""&&(s=null),t==null||t.lines.push(r);continue}const o=s===null?r.match(hn):null;if(o){const[,c,d]=o;if(!pn(c))return null;t={role:c,label:(d==null?void 0:d.trim())||void 0,lines:[]},n.push(t);continue}if(t){t.lines.push(r);continue}if(r.trim()!=="")return null}return n}function gn(e){const{data:n,content:t}=q(e),s=(n.title??"").trim(),r=(n.trigger??"").trim(),h=(n.caveat??"").trim();if(s===""||r===""||h==="")return null;const o=mn(ie(t));if(o===null||o.length===0||o[0].role!=="user")return null;const c=o.map(d=>({...d,body:d.lines.join(`
`).trim()})).filter(d=>d.body!=="").map(({role:d,label:l,body:p})=>l===void 0?{role:d,body:p}:{role:d,label:l,body:p});return c.length===0?null:{title:s,trigger:r,caveat:h,turns:c}}function fn(e){const n=new Map;for(const[t,s]of Object.entries(e)){const r=t.split("/").filter(Boolean),h=r.length>1?r.at(-2)??"":"",o=h===""?null:gn(s);o&&n.set(h,o)}return n}const bn=Object.assign({"../../agent-skills/commands/background.md":be,"../../agent-skills/commands/build-waves.md":ye,"../../agent-skills/commands/cite-file-lines.md":ve,"../../agent-skills/commands/dca.md":we,"../../agent-skills/commands/deep-research.md":ke,"../../agent-skills/commands/diagram.md":_e,"../../agent-skills/commands/docs-preview.md":xe,"../../agent-skills/commands/duck-mode.md":Te,"../../agent-skills/commands/goal.md":Re,"../../agent-skills/commands/grill-me.md":Se,"../../agent-skills/commands/handoff.md":Ee,"../../agent-skills/commands/leaving-now-wrap-up.md":Ae,"../../agent-skills/commands/manager-children.md":Ce,"../../agent-skills/commands/mini-design-doc.md":Ie,"../../agent-skills/commands/native-worktree-subagents.md":De,"../../agent-skills/commands/red-team.md":Ne,"../../agent-skills/commands/research-handoff.md":Pe,"../../agent-skills/commands/review-learning.md":je,"../../agent-skills/commands/session-handoff.md":qe,"../../agent-skills/commands/standup.md":Oe,"../../agent-skills/commands/system-design-artifacts.md":$e,"../../agent-skills/commands/verify.md":Ue,"../../agent-skills/commands/worktree-up.md":Fe}),yn=Object.assign({"../../agent-skills/command-simulations/background.md":Me,"../../agent-skills/command-simulations/build-waves.md":Le,"../../agent-skills/command-simulations/cite-file-lines.md":Be,"../../agent-skills/command-simulations/dca.md":ze,"../../agent-skills/command-simulations/deep-research.md":We,"../../agent-skills/command-simulations/diagram.md":Ge,"../../agent-skills/command-simulations/docs-preview.md":He,"../../agent-skills/command-simulations/duck-mode.md":Ve,"../../agent-skills/command-simulations/goal.md":Ke,"../../agent-skills/command-simulations/grill-me.md":Ye,"../../agent-skills/command-simulations/handoff.md":Xe,"../../agent-skills/command-simulations/leaving-now-wrap-up.md":Qe,"../../agent-skills/command-simulations/manager-children.md":Je,"../../agent-skills/command-simulations/mini-design-doc.md":Ze,"../../agent-skills/command-simulations/native-worktree-subagents.md":en,"../../agent-skills/command-simulations/red-team.md":nn,"../../agent-skills/command-simulations/research-handoff.md":tn,"../../agent-skills/command-simulations/review-learning.md":an,"../../agent-skills/command-simulations/session-handoff.md":sn,"../../agent-skills/command-simulations/standup.md":on,"../../agent-skills/command-simulations/system-design-artifacts.md":rn,"../../agent-skills/command-simulations/verify.md":dn,"../../agent-skills/command-simulations/worktree-up.md":cn});function vn(e){return Object.fromEntries(Object.entries(e).map(([n,t])=>{var r;return[`commands/${((r=n.split("/").pop())==null?void 0:r.replace(/\.md$/u,""))??""}/SIMULATION.md`,t]}))}const R=le(bn,{simulations:fn(vn(yn))});function Xt(e){return R.find(n=>n.name===e)}const wn="https://github.com/leoncheng57/custom-dca-opencode",kn="main",D=`${wn}/blob/${kn}/agent-skills`,Qt={command:e=>`${D}/commands/${e}.md`,commandSimulation:e=>`${D}/command-simulations/${e}.md`},F={status:"unknown",directoryLabel:"",installedCommands:new Set},T=F;function _n(e){const n=e.replace(/\/+$/u,"");return n.slice(n.lastIndexOf("/")+1)||n}function xn(e,n){return!e||!n?F:{status:"ready",directoryLabel:_n(e),installedCommands:new Set(n.commands.map(t=>t.name))}}function Tn(){const e=N(),[n,t]=f.useState(T);return f.useEffect(()=>{const s=z(e.search,typeof localStorage>"u"?null:localStorage.getItem(W));if(!s){t(T);return}const r=new AbortController;let h=!1;return G.catalog(s,r.signal).then(o=>{h||t(xn(s,o))}).catch(()=>{h||t(T)}),()=>{h=!0,r.abort()}},[e.search]),n}const Rn="_page_khz9n_1",Sn="_content_khz9n_8",En="_wipWarning_khz9n_14",An="_eyebrow_khz9n_16",Cn="_type_khz9n_16",In="_filterLabel_khz9n_16",Dn="_filterInput_khz9n_16",Nn="_meta_khz9n_16",Pn="_source_khz9n_16",jn="_terminal_khz9n_16",qn="_methodScope_khz9n_16",On="_hero_khz9n_20",$n="_modalTitle_khz9n_37",Un="_cardTitle_khz9n_37",Fn="_sectionTitle_khz9n_37",Mn="_lede_khz9n_42",Ln="_typeStats_khz9n_44",Bn="_typeStat_khz9n_44",zn="_catalog_khz9n_49",Wn="_catalogHead_khz9n_50",Gn="_filter_khz9n_16",Hn="_clear_khz9n_56",Vn="_cardLink_khz9n_57",Kn="_grid_khz9n_60",Yn="_card_khz9n_37",Xn="_cardTop_khz9n_62",Qn="_typeCommand_khz9n_63",Jn="_loadState_khz9n_66",Zn="_loadStateOn_khz9n_67",et="_loadStateOff_khz9n_68",nt="_scopeNote_khz9n_69",tt="_cardCommand_khz9n_70",at="_cardCopy_khz9n_71",st="_cardTags_khz9n_71",it="_empty_khz9n_72",ot="_locations_khz9n_74",rt="_tableWrap_khz9n_74",dt="_table_khz9n_74",ct="_dialog_khz9n_76",lt="_dialogBody_khz9n_77",ht="_close_khz9n_77",ut="_modalHead_khz9n_78",pt="_modalDescription_khz9n_78",mt="_route_khz9n_78",gt="_detailGrid_khz9n_79",ft="_side_khz9n_79",bt="_terminalBar_khz9n_81",yt="_light_khz9n_81",vt="_terminalPath_khz9n_81",wt="_terminalSource_khz9n_81",kt="_terminalTurns_khz9n_81",_t="_turn_khz9n_81",xt="_turnRole_khz9n_81",Tt="_turnAssistant_khz9n_81",Rt="_turnTool_khz9n_81",St="_turnNote_khz9n_81",Et="_terminalControls_khz9n_85",At="_terminalButton_khz9n_85",Ct="_terminalButtonPrimary_khz9n_85",It="_terminalStatus_khz9n_85",Dt="_progress_khz9n_85",Nt="_terminalCaveat_khz9n_85",Pt="_disclosures_khz9n_87",jt="_disclosure_khz9n_87",qt="_disclosureMeta_khz9n_87",Ot="_disclosureBody_khz9n_87",$t="_descriptionPanel_khz9n_87",Ut="_descriptionBar_khz9n_87",Ft="_descriptionBody_khz9n_87",Mt="_method_khz9n_16",Lt="_methodHead_khz9n_87",Bt="_methodCopy_khz9n_87",zt="_command_khz9n_87",Wt="_notFound_khz9n_87",i={page:Rn,content:Sn,wipWarning:En,eyebrow:An,type:Cn,filterLabel:In,filterInput:Dn,meta:Nn,source:Pn,terminal:jn,methodScope:qn,hero:On,modalTitle:$n,cardTitle:Un,sectionTitle:Fn,lede:Mn,typeStats:Ln,typeStat:Bn,catalog:zn,catalogHead:Wn,filter:Gn,clear:Hn,cardLink:Vn,grid:Kn,card:Yn,cardTop:Xn,typeCommand:Qn,loadState:Jn,loadStateOn:Zn,loadStateOff:et,scopeNote:nt,cardCommand:tt,cardCopy:at,cardTags:st,empty:it,locations:ot,tableWrap:rt,table:dt,dialog:ct,dialogBody:lt,close:ht,modalHead:ut,modalDescription:pt,route:mt,detailGrid:gt,side:ft,terminalBar:bt,light:yt,terminalPath:vt,terminalSource:wt,terminalTurns:kt,turn:_t,turnRole:xt,turnAssistant:Tt,turnTool:Rt,turnNote:St,terminalControls:Et,terminalButton:At,terminalButtonPrimary:Ct,terminalStatus:It,progress:Dt,terminalCaveat:Nt,disclosures:Pt,disclosure:jt,disclosureMeta:qt,disclosureBody:Ot,descriptionPanel:$t,descriptionBar:Ut,descriptionBody:Ft,method:Mt,methodHead:Lt,methodCopy:Bt,command:zt,notFound:Wt};function M({install:e,installed:n}){return e.status!=="ready"?null:a.jsxs("span",{className:`${i.loadState} ${n?i.loadStateOn:i.loadStateOff}`,"data-installed":n,"data-testid":"opencode-playbook-command-load-state",title:`Reported by the OpenCode server for ${e.directoryLabel}. Installation is per project.`,children:[n?"Loaded":"Not loaded"," in ",e.directoryLabel]})}function Gt({command:e,install:n}){return a.jsxs("article",{className:`${i.card} ${i.cardCommand}`,"data-playbook-kind":"command","data-testid":"opencode-playbook-command-card",children:[a.jsxs("div",{className:i.cardTop,children:[a.jsxs("span",{className:`${i.type} ${i.typeCommand}`,children:[a.jsx(X,{"aria-hidden":"true",size:10})," Command · human-invoked"]}),a.jsx("span",{className:i.meta,children:e.subtask?"subtask":"session"})]}),a.jsx(M,{install:n,installed:n.installedCommands.has(e.name)}),a.jsx("h2",{className:i.cardTitle,children:de(e.name,e.takesArguments)}),a.jsx("p",{className:i.cardCopy,children:e.description}),a.jsxs("div",{className:i.cardTags,children:[e.runsShell&&a.jsx("span",{children:"shell input"}),e.agent&&a.jsx("span",{children:e.agent})]}),a.jsx(K,{className:i.cardLink,"data-testid":`opencode-playbook-command-${e.name}`,to:`/playbooks/commands/${e.name}`,children:"Read command →"})]})}function Ht(){return a.jsxs("section",{className:i.locations,"aria-labelledby":"command-locations-heading",children:[a.jsx("div",{className:i.eyebrow,children:"Install locations"}),a.jsx("h2",{className:i.sectionTitle,id:"command-locations-heading",children:"Where commands live"}),a.jsx("p",{children:"Commands are individual OpenCode Markdown files. They add zero retrieval context until a human explicitly invokes one."}),a.jsx("div",{className:i.tableWrap,children:a.jsxs("table",{className:i.table,children:[a.jsx("thead",{children:a.jsxs("tr",{children:[a.jsx("th",{scope:"col",children:"Path"}),a.jsx("th",{scope:"col",children:"Scope"}),a.jsx("th",{scope:"col",children:"Read by"})]})}),a.jsx("tbody",{children:fe.map(e=>a.jsxs("tr",{children:[a.jsx("th",{scope:"row",children:e.path}),a.jsx("td",{children:e.scope}),a.jsxs("td",{children:[e.readBy,a.jsx("span",{children:e.note})]})]},e.path))})]})})]})}function Vt({detail:e}){var d;const[n,t]=f.useState(""),s=f.useRef(null),r=f.useRef(null),h=((d=N().state)==null?void 0:d.focusCatalog)===!0;f.useEffect(()=>{var l;h&&((l=r.current)==null||l.focus())},[h]);const o=Tn(),c=f.useMemo(()=>he(R,n),[n]);return a.jsxs("main",{className:i.page,"data-testid":"opencode-playbooks",ref:r,tabIndex:-1,children:[a.jsxs("div",{className:i.content,children:[a.jsx(H,{className:i.wipWarning,"data-testid":"opencode-playbooks-wip-warning",variant:"warning",children:"Playbooks is still work in progress and its UI/UX may contain bugs."}),a.jsxs("header",{className:i.hero,children:[a.jsxs("div",{children:[a.jsx("div",{className:i.eyebrow,children:"Repository-owned commands"}),a.jsx("h1",{children:"Repeatable work, invoked on purpose."}),a.jsx("p",{className:i.lede,children:"Each Playbook is an explicit slash command. Nothing is retrieved or added to agent context until a human invokes it; runtime reminders remain a separate per-message mechanism."})]}),a.jsxs("aside",{className:i.typeStats,"aria-label":"Playbook types",children:[a.jsxs("div",{className:i.typeStat,children:[a.jsx("strong",{children:R.length}),a.jsx("span",{children:"Commands"})]}),a.jsxs("div",{className:i.typeStat,children:[a.jsx("strong",{children:"0"}),a.jsx("span",{children:"At-rest tokens"})]})]})]}),a.jsxs("section",{className:i.catalog,"aria-labelledby":"playbook-catalog-heading",children:[a.jsxs("div",{className:i.catalogHead,children:[a.jsxs("div",{children:[a.jsx("div",{className:i.eyebrow,children:"Catalogue"}),a.jsxs("h2",{className:i.sectionTitle,id:"playbook-catalog-heading",children:[c.length," matching commands"]})]}),a.jsxs("label",{className:i.filter,children:[a.jsx(V,{"aria-hidden":"true",size:14}),a.jsx("span",{className:i.filterLabel,children:"filter"}),a.jsx("input",{className:i.filterInput,"data-testid":"opencode-playbook-filter",onChange:l=>t(l.target.value),placeholder:"name, description, or instruction",ref:s,type:"search",value:n}),n&&a.jsx("button",{"aria-label":"Clear filter",className:i.clear,"data-testid":"opencode-playbook-filter-clear",onClick:()=>{var l;t(""),(l=s.current)==null||l.focus()},type:"button",children:"×"})]})]}),c.length?a.jsx("div",{className:i.grid,children:c.map(l=>a.jsx(Gt,{command:l,install:o},l.name))}):a.jsxs("p",{className:i.empty,children:["No command matches ",a.jsx("code",{children:n.trim()}),"."]})]}),a.jsx(Ht,{})]}),e]})}const Jt=Object.freeze(Object.defineProperty({__proto__:null,InstallState:M,PlaybooksPage:Vt},Symbol.toStringTag,{value:"Module"}));export{M as I,Vt as P,kn as a,Jt as b,Yt as c,Xt as f,de as i,Qt as p,i as s,Tn as u};
