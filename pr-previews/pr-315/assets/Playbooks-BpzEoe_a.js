import{c as W,b as B,r as f,d as Z,D as J,e as ee,j as s,A as ne,S as te,L as D}from"./index-q-PUZbwD.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const oe=[["path",{d:"m7 11 2-2-2-2",key:"1lz0vl"}],["path",{d:"M11 13h4",key:"1p7l4v"}],["rect",{width:"18",height:"18",x:"3",y:"3",rx:"2",ry:"2",key:"1m3agn"}]],ie=W("square-terminal",oe),re=/^([|>])([+-]?)(\d*)([+-]?)$/,q=/^(\s*)([A-Za-z0-9_.-]+)\s*:\s?(.*)$/,L=/^(\s*)-\s+(.*)$/;function x(e){return e.length-e.trimStart().length}function E(e,n){if(e.length<2||!e.startsWith(n)||!e.endsWith(n))return!1;const t=e.slice(1,-1);if(n==="'"){for(let a=0;a<t.length;a+=1)if(t[a]==="'"){if(t[a+1]==="'"){a+=1;continue}return!1}return!0}for(let a=0;a<t.length;a+=1){if(t[a]==="\\"){a+=1;continue}if(t[a]==='"')return!1}return!0}function G(e){return E(e,'"')?e.slice(1,-1).replace(/\\(["\\])/g,"$1"):E(e,"'")?e.slice(1,-1).replace(/''/g,"'"):e}function H(e){if(e.startsWith('"')||e.startsWith("'"))return e;const n=e.search(/(^|\s)#/);return n===-1?e:e.slice(0,n)}function $(e){const n=H(e.trim()).trim();return G(n)}function le(e){const n=H(e.trim()).trim();if(E(n,'"')||E(n,"'"))return G(n);if(n==="true")return!0;if(n==="false")return!1;if(n!==""){const t=Number(n);if(!Number.isNaN(t))return t}return n}function de(e){let n="",t=0;for(const a of e){if(a===""){t+=1;continue}n===""?n=a:(n+=t>0?`
`.repeat(t):" ",n+=a),t=0}return n}function ce(e,n,t){return t==="strip"?e:t==="keep"?e+`
`.repeat(n+1):e===""?"":`${e}
`}function he(e,n,t,a,i){const d=[];let r=n;for(;r+1<e.length;){const m=e[r+1];if(m.trim()===""){d.push(""),r+=1;continue}if(x(m)<=t)break;d.push(m),r+=1}let h=d.length-1;for(;h>=0&&d[h]==="";)h-=1;const c=d.length-1-h,u=d.slice(0,h+1),p=u.reduce((m,l)=>l===""?m:Math.min(m,x(l)),Number.MAX_SAFE_INTEGER),w=u.map(m=>m===""?"":m.slice(Math.min(p,x(m)))),y=a==="|"?w.join(`
`):de(w);return{value:ce(y,c,i),endIndex:r}}function ue(e){const n=e[2]||e[4];return n==="-"?"strip":n==="+"?"keep":"clip"}function pe(e,n){for(let t=n+1;t<e.length;t+=1){const a=e[t];if(!(a.trim()===""||a.trimStart().startsWith("#")))return a}}function me(e){return e.replace(/^\uFEFF/,"").replace(/\r\n?/g,`
...
`),r={};let h=null,c=null;for(let u=0;u<i.length;u+=1){const p=i[u];if(p.trim()===""||p.trimStart().startsWith("#"))continue;const w=p.match(L);if(w&&h){const g=r[h];Array.isArray(g)&&g.push($(w[2]));continue}const y=p.match(q);if(!y){h=null,c=null;continue}const[,m,l,k]=y,v=m.length>0;if(v&&!c)continue;v||(c=null,h=null);const j=k.trim(),R=j.match(re);if(R){const{value:g,endIndex:Q}=he(i,u,m.length,R[1],ue(R));u=Q,v&&c?r[c][l]=g:r[l]=g;continue}if(j===""){const g=pe(i,u);if(g&&L.test(g)&&x(g)>=m.length){r[l]=[],h=l,c=null;continue}if(g&&x(g)>m.length&&q.test(g)){r[l]={},c=l,h=null;continue}v&&c?r[c][l]="":r[l]="";continue}if(v&&c){r[c][l]=$(k);continue}r[l]=le(k),h=null}return{data:r,content:d}}function V(e){return e.replace(/^\s*#\s+.+?(\n+|$)/,"")}const ge=/\$ARGUMENTS\b|\$[1-9]\b/,fe=/!`[^`]+`/,we=/`([a-z0-9]+(?:-[a-z0-9]+)*)`/g;function be(e,n){const t=e.replace(/!`[^`]+`/g," "),a=[];for(const i of t.matchAll(we)){const d=i[1];n.has(d)&&!a.includes(d)&&a.push(d)}return a}function K(e){const n=e.split("/").filter(Boolean).pop()??"";return n.endsWith(".md")?n.slice(0,-3):""}function ye(e,n){return n?`/${e} <arguments>`:`/${e}`}function ke(e,n,t={}){const a=K(e);if(!a)return null;const{data:i,content:d}=P(n),r=d.trim(),h=(i.description??"").trim();if(r==="")return null;const c=be(r,t.skillNames??new Set);return{name:a,description:h,agent:i.agent,model:i.model,subtask:i.subtask===!0,body:r,takesArguments:ge.test(r),runsShell:fe.test(r),relatedSkills:c,...t.simulation?{simulation:t.simulation}:{},bytes:typeof TextEncoder>"u"?n.length:new TextEncoder().encode(n).length}}function ve(e,n={}){return Object.entries(e).map(([t,a])=>{var i;return ke(t,a,{skillNames:n.skillNames,simulation:(i=n.simulations)==null?void 0:i.get(K(t))})}).filter(t=>t!==null).sort((t,a)=>t.name.localeCompare(a.name))}function xe(e,n){const t=n.trim().toLowerCase();return t===""?e:e.filter(a=>[a.name,a.description,a.body,a.relatedSkills.join(" ")].join(" ").toLowerCase().includes(t))}const _e="leoncheng57",z="custom-dca-opencode",_=`${_e}/${z}`,N=`https://github.com/${_}`,b="agent-skills",A="main",Te=`${z}-${A}`;function Za(e){const n=`https://raw.githubusercontent.com/${_}/${A}/${b}/commands/${e}.md`;return[{id:"curl-global",label:"curl",scope:"global",note:"Recommended. Available in every project you open with OpenCode.",command:["mkdir -p ~/.config/opencode/commands && \\",`curl -sL ${n} \\`,`  -o ~/.config/opencode/commands/${e}.md`].join(`
...
`)}]}const Ee=[{path:"~/.agents/skills/<skill>/",scope:"Global",readBy:"OpenCode, Cursor, Codex, Copilot, Gemini CLI, Amp, Roo, Zed",note:"Highest reach — install here unless you have a reason not to."},{path:"~/.claude/skills/<skill>/",scope:"Global",readBy:"Claude Code",note:"The Claude Code variant of the same layout."},{path:".agents/skills/<skill>/",scope:"Project",readBy:"OpenCode, Cursor, Codex, Copilot, Gemini CLI, Amp, Roo, Zed",note:"Highest reach at project scope — commit it and every collaborator gets the skill."},{path:".opencode/skills/<skill>/",scope:"Project",readBy:"OpenCode",note:"Committed with the repo, so the skill only loads inside that project."},{path:".claude/skills/<skill>/",scope:"Project",readBy:"Claude Code",note:"Project-scoped equivalent for Claude Code."}],Ae=220,Se=new Set(["e.g","i.e","etc","vs","cf","approx","al","mr","ms","dr","no"]),Re=240;function O(e){const n=e.split("/").filter(Boolean);return n[n.length-2]??""}function Ce(e){return e.split(/[-_]+/).filter(Boolean).map(n=>/[A-Z]/.test(n)?n:n.charAt(0).toUpperCase()+n.slice(1)).join(" ")}function Ne(e,n=Re){const t=e.replace(/\s+/g," ").trim();if(t==="")return"";for(let a=0;a<t.length;a+=1){if(!".!?".includes(t[a]))continue;const i=t[a+1];if(i!==void 0&&i!==" ")continue;const d=t.slice(0,a).split(/[\s(]/).pop();if(t[a]==="."&&d&&Se.has(d.toLowerCase()))continue;const r=t.slice(0,a+1);return r.length<=n?r:M(r,n)}return t.length<=n?t:M(t,n)}function M(e,n){const t=e.slice(0,n),a=t.lastIndexOf(" ");return`${(a>n*.6?t.slice(0,a):t).replace(/[,;:.\s]+$/,"")}…`}function De(e){if(!e)return[];const n=new Set;return e.split(",").map(t=>t.trim()).filter(t=>t===""||n.has(t.toLowerCase())?!1:(n.add(t.toLowerCase()),!0))}function Pe(e){const n=e.trim().split(/\s+/).filter(Boolean).length;return Math.max(1,Math.round(n/Ae))}function Oe(e){return typeof TextEncoder>"u"?e.length:new TextEncoder().encode(e).length}function Ue(e,n,t){var p;const a=O(e);if(!a)return null;const{data:i,content:d}=P(n),r=i.metadata??{},h=a,c=(i.description??"").trim(),u=V(d).trim();return{name:h,title:((p=r.title)==null?void 0:p.trim())||Ce(h),description:c,summary:Ne(c),tags:De(r.tags),license:i.license,compatibility:i.compatibility,metadata:r,body:u,readingTimeMinutes:Pe(u),bytes:Oe(n),...t?{simulation:t}:{}}}function je(e,n=new Map){return Object.entries(e).map(([t,a])=>Ue(t,a,n.get(O(t)))).filter(t=>t!==null).sort((t,a)=>t.name.localeCompare(a.name))}function qe(e,n){const t=n.trim().toLowerCase();return t===""?e:e.filter(a=>[a.name,a.title,a.description,a.tags.join(" ")].join(" ").toLowerCase().includes(t))}function Le(e){return[...new Set(e.flatMap(n=>n.tags))].sort((n,t)=>n.localeCompare(t))}const $e=`---
name: ascii-diagrams
...
`,tt=["user","assistant","tool","note"],at=/^##[ \t]+([a-z]+)(?:[ \t]+—[ \t]*(.*))?[ \t]*$/,st=/^[ \t]{0,3}(`{3,}|~{3,})(.*)$/;function ot(e){return tt.includes(e)}function it(e){const n=[];let t=null,a=null;for(const i of e.split(`
`)){const d=i.match(st);if(d){const[,h,c]=d;a===null?a=h:h[0]===a[0]&&h.length>=a.length&&c.trim()===""&&(a=null),t==null||t.lines.push(i);continue}const r=a===null?i.match(at):null;if(r){const[,h,c]=r;if(!ot(h))return null;t={role:h,label:(c==null?void 0:c.trim())||void 0,lines:[]},n.push(t);continue}if(t){t.lines.push(i);continue}if(i.trim()!=="")return null}return n}function rt(e){const{data:n,content:t}=P(e),a=(n.title??"").trim(),i=(n.trigger??"").trim(),d=(n.caveat??"").trim();if(a===""||i===""||d==="")return null;const r=it(V(t));if(r===null||r.length===0||r[0].role!=="user")return null;const h=r.map(c=>({...c,body:c.lines.join(`
`).trim()})).filter(c=>c.body!=="").map(({role:c,label:u,body:p})=>u===void 0?{role:c,body:p}:{role:c,label:u,body:p});return h.length===0?null:{title:a,trigger:i,caveat:d,turns:h}}function Y(e){const n=new Map;for(const[t,a]of Object.entries(e)){const i=O(t),d=i===""?null:rt(a);d&&n.set(i,d)}return n}const lt=Object.assign({"../../agent-skills/skills/ascii-diagrams/SKILL.md":$e,"../../agent-skills/skills/background-subagent/SKILL.md":Me,"../../agent-skills/skills/build-waves/SKILL.md":Fe,"../../agent-skills/skills/cite-file-lines/SKILL.md":We,"../../agent-skills/skills/deep-research-subagents/SKILL.md":Be,"../../agent-skills/skills/docs-and-diagram-tooling/SKILL.md":Ge,"../../agent-skills/skills/duck-mode/SKILL.md":He,"../../agent-skills/skills/grill-me/SKILL.md":Ve,"../../agent-skills/skills/human-verification-steps/SKILL.md":Ke,"../../agent-skills/skills/manager-children/SKILL.md":ze,"../../agent-skills/skills/native-worktree-subagents/SKILL.md":Ye,"../../agent-skills/skills/parallel-research-handoff/SKILL.md":Xe,"../../agent-skills/skills/red-team-this/SKILL.md":Qe,"../../agent-skills/skills/session-handoff/SKILL.md":Ze,"../../agent-skills/skills/worktree-up/SKILL.md":Je}),dt=Object.assign({"../../agent-skills/skills/ascii-diagrams/SIMULATION.md":en,"../../agent-skills/skills/background-subagent/SIMULATION.md":nn,"../../agent-skills/skills/build-waves/SIMULATION.md":tn,"../../agent-skills/skills/cite-file-lines/SIMULATION.md":an,"../../agent-skills/skills/deep-research-subagents/SIMULATION.md":sn,"../../agent-skills/skills/docs-and-diagram-tooling/SIMULATION.md":on,"../../agent-skills/skills/duck-mode/SIMULATION.md":rn,"../../agent-skills/skills/grill-me/SIMULATION.md":ln,"../../agent-skills/skills/human-verification-steps/SIMULATION.md":dn,"../../agent-skills/skills/manager-children/SIMULATION.md":cn,"../../agent-skills/skills/native-worktree-subagents/SIMULATION.md":hn,"../../agent-skills/skills/parallel-research-handoff/SIMULATION.md":un,"../../agent-skills/skills/red-team-this/SIMULATION.md":pn,"../../agent-skills/skills/session-handoff/SIMULATION.md":mn,"../../agent-skills/skills/worktree-up/SIMULATION.md":gn}),ct=Object.assign({"../../agent-skills/commands/background.md":fn,"../../agent-skills/commands/build-waves.md":wn,"../../agent-skills/commands/cite-file-lines.md":bn,"../../agent-skills/commands/dca.md":yn,"../../agent-skills/commands/deep-research.md":kn,"../../agent-skills/commands/diagram.md":vn,"../../agent-skills/commands/docs-preview.md":xn,"../../agent-skills/commands/duck-mode.md":_n,"../../agent-skills/commands/goal.md":Tn,"../../agent-skills/commands/grill-me.md":In,"../../agent-skills/commands/handoff.md":En,"../../agent-skills/commands/leaving-now-wrap-up.md":An,"../../agent-skills/commands/manager-children.md":Sn,"../../agent-skills/commands/native-worktree-subagents.md":Rn,"../../agent-skills/commands/red-team.md":Cn,"../../agent-skills/commands/research-handoff.md":Nn,"../../agent-skills/commands/session-handoff.md":Dn,"../../agent-skills/commands/standup.md":Pn,"../../agent-skills/commands/verify.md":On,"../../agent-skills/commands/worktree-up.md":Un}),ht=Object.assign({"../../agent-skills/command-simulations/background.md":jn,"../../agent-skills/command-simulations/build-waves.md":qn,"../../agent-skills/command-simulations/cite-file-lines.md":Ln,"../../agent-skills/command-simulations/dca.md":$n,"../../agent-skills/command-simulations/deep-research.md":Mn,"../../agent-skills/command-simulations/diagram.md":Fn,"../../agent-skills/command-simulations/docs-preview.md":Wn,"../../agent-skills/command-simulations/duck-mode.md":Bn,"../../agent-skills/command-simulations/goal.md":Gn,"../../agent-skills/command-simulations/grill-me.md":Hn,"../../agent-skills/command-simulations/handoff.md":Vn,"../../agent-skills/command-simulations/leaving-now-wrap-up.md":Kn,"../../agent-skills/command-simulations/manager-children.md":zn,"../../agent-skills/command-simulations/native-worktree-subagents.md":Yn,"../../agent-skills/command-simulations/red-team.md":Xn,"../../agent-skills/command-simulations/research-handoff.md":Qn,"../../agent-skills/command-simulations/session-handoff.md":Zn,"../../agent-skills/command-simulations/standup.md":Jn,"../../agent-skills/command-simulations/verify.md":et,"../../agent-skills/command-simulations/worktree-up.md":nt});function ut(e){return Object.fromEntries(Object.entries(e).map(([n,t])=>{var i;return[`commands/${((i=n.split("/").pop())==null?void 0:i.replace(/\.md$/u,""))??""}/SIMULATION.md`,t]}))}const T=je(lt,Y(dt)),S=ve(ct,{skillNames:new Set(T.map(e=>e.name)),simulations:Y(ut(ht))});function es(e){return T.find(n=>n.name===e)}function ns(e){return S.find(n=>n.name===e)}function ts(e){return S.find(n=>n.relatedSkills.length===1&&n.relatedSkills[0]===e)}const pt="https://github.com/leoncheng57/custom-dca-opencode",mt="main",I=`${pt}/blob/${mt}/agent-skills`,as={skill:e=>`${I}/skills/${e}/SKILL.md`,skillSimulation:e=>`${I}/skills/${e}/SIMULATION.md`,command:e=>`${I}/commands/${e}.md`,commandSimulation:e=>`${I}/command-simulations/${e}.md`},X={status:"unknown",directoryLabel:"",installedSkills:new Set,installedCommands:new Set},C=X;function gt(e){const n=e.replace(/\/+$/u,"");return n.slice(n.lastIndexOf("/")+1)||n}function ft(e,n){return!e||!n?X:{status:"ready",directoryLabel:gt(e),installedSkills:new Set(n.skills.map(t=>t.name)),installedCommands:new Set(n.commands.map(t=>t.name))}}function wt(){const e=B(),[n,t]=f.useState(C);return f.useEffect(()=>{const a=Z(e.search,typeof localStorage>"u"?null:localStorage.getItem(J));if(!a){t(C);return}const i=new AbortController;let d=!1;return ee.catalog(a,i.signal).then(r=>{d||t(ft(a,r))}).catch(()=>{d||t(C)}),()=>{d=!0,i.abort()}},[e.search]),n}const bt="_page_1ec81_1",yt="_content_1ec81_8",kt="_wipWarning_1ec81_14",vt="_eyebrow_1ec81_16",xt="_type_1ec81_16",_t="_count_1ec81_16",Tt="_filterLabel_1ec81_16",It="_filterInput_1ec81_16",Et="_tag_1ec81_16",At="_meta_1ec81_16",St="_source_1ec81_16",Rt="_terminal_1ec81_16",Ct="_methodScope_1ec81_16",Nt="_hero_1ec81_20",Dt="_modalTitle_1ec81_37",Pt="_cardTitle_1ec81_37",Ot="_sectionTitle_1ec81_37",Ut="_lede_1ec81_42",jt="_typeStats_1ec81_44",qt="_typeStat_1ec81_44",Lt="_catalog_1ec81_49",$t="_catalogHead_1ec81_50",Mt="_filter_1ec81_16",Ft="_clear_1ec81_57",Wt="_tab_1ec81_58",Bt="_cardLink_1ec81_58",Gt="_tabs_1ec81_60",Ht="_tags_1ec81_60",Vt="_tabActive_1ec81_64",Kt="_grid_1ec81_68",zt="_card_1ec81_37",Yt="_cardTop_1ec81_70",Xt="_typeSkill_1ec81_74",Qt="_typeCommand_1ec81_75",Zt="_loadState_1ec81_78",Jt="_loadStateOn_1ec81_79",ea="_loadStateOff_1ec81_80",na="_scopeNote_1ec81_81",ta="_cardSkill_1ec81_82",aa="_cardCommand_1ec81_83",sa="_cardCopy_1ec81_84",oa="_cardTags_1ec81_84",ia="_empty_1ec81_85",ra="_locations_1ec81_87",la="_tableWrap_1ec81_87",da="_table_1ec81_87",ca="_dialog_1ec81_89",ha="_dialogBody_1ec81_90",ua="_close_1ec81_90",pa="_modalHead_1ec81_91",ma="_modalDescription_1ec81_91",ga="_route_1ec81_91",fa="_detailGrid_1ec81_92",wa="_side_1ec81_92",ba="_terminalBar_1ec81_94",ya="_light_1ec81_94",ka="_terminalPath_1ec81_94",va="_terminalSource_1ec81_94",xa="_terminalTurns_1ec81_94",_a="_turn_1ec81_94",Ta="_turnRole_1ec81_94",Ia="_turnAssistant_1ec81_94",Ea="_turnTool_1ec81_94",Aa="_turnNote_1ec81_94",Sa="_terminalControls_1ec81_98",Ra="_terminalButton_1ec81_98",Ca="_terminalButtonPrimary_1ec81_98",Na="_terminalStatus_1ec81_98",Da="_progress_1ec81_98",Pa="_terminalCaveat_1ec81_98",Oa="_disclosures_1ec81_100",Ua="_disclosure_1ec81_100",ja="_disclosureMeta_1ec81_100",qa="_disclosureBody_1ec81_100",La="_descriptionPanel_1ec81_100",$a="_descriptionBar_1ec81_100",Ma="_descriptionBody_1ec81_100",Fa="_relation_1ec81_100",Wa="_method_1ec81_16",Ba="_methodHead_1ec81_100",Ga="_methodCopy_1ec81_100",Ha="_command_1ec81_100",Va="_notFound_1ec81_100",o={page:bt,content:yt,wipWarning:kt,eyebrow:vt,type:xt,count:_t,filterLabel:Tt,filterInput:It,tag:Et,meta:At,source:St,terminal:Rt,methodScope:Ct,hero:Nt,modalTitle:Dt,cardTitle:Pt,sectionTitle:Ot,lede:Ut,typeStats:jt,typeStat:qt,catalog:Lt,catalogHead:$t,filter:Mt,clear:Ft,tab:Wt,cardLink:Bt,tabs:Gt,tags:Ht,tabActive:Vt,grid:Kt,card:zt,cardTop:Yt,typeSkill:Xt,typeCommand:Qt,loadState:Zt,loadStateOn:Jt,loadStateOff:ea,scopeNote:na,cardSkill:ta,cardCommand:aa,cardCopy:sa,cardTags:oa,empty:ia,locations:ra,tableWrap:la,table:da,dialog:ca,dialogBody:ha,close:ua,modalHead:pa,modalDescription:ma,route:ga,detailGrid:fa,side:wa,terminalBar:ba,light:ya,terminalPath:ka,terminalSource:va,terminalTurns:xa,turn:_a,turnRole:Ta,turnAssistant:Ia,turnTool:Ea,turnNote:Aa,terminalControls:Sa,terminalButton:Ra,terminalButtonPrimary:Ca,terminalStatus:Na,progress:Da,terminalCaveat:Pa,disclosures:Oa,disclosure:Ua,disclosureMeta:ja,disclosureBody:qa,descriptionPanel:La,descriptionBar:$a,descriptionBody:Ma,relation:Fa,method:Wa,methodHead:Ba,methodCopy:Ga,command:Ha,notFound:Va};function U({install:e,installed:n,kind:t}){return e.status!=="ready"?null:s.jsxs("span",{className:`${o.loadState} ${n?o.loadStateOn:o.loadStateOff}`,"data-installed":n,"data-testid":`opencode-playbook-${t}-load-state`,title:`Reported by the OpenCode server for ${e.directoryLabel}. Installation is per project.`,children:[n?"Loaded":"Not loaded"," in ",e.directoryLabel]})}function Ka({install:e,skill:n,onTag:t}){return s.jsxs("article",{className:`${o.card} ${o.cardSkill}`,"data-playbook-kind":"skill","data-testid":"opencode-playbook-skill-card",children:[s.jsxs("div",{className:o.cardTop,children:[s.jsxs("span",{className:`${o.type} ${o.typeSkill}`,children:[s.jsx(se,{"aria-hidden":"true",size:10})," Skill · model-selected"]}),s.jsxs("span",{className:o.meta,children:[n.readingTimeMinutes," min"]})]}),s.jsx(U,{install:e,installed:e.installedSkills.has(n.name),kind:"skill"}),s.jsx("h2",{className:o.cardTitle,children:n.title}),s.jsx("p",{className:o.cardCopy,children:n.summary}),s.jsx("div",{className:o.cardTags,children:n.tags.map(a=>s.jsxs("button",{className:o.tag,"data-testid":"opencode-playbook-tag",onClick:()=>t(a),type:"button",children:["#",a]},a))}),s.jsx(D,{className:o.cardLink,"data-testid":`opencode-playbook-skill-${n.name}`,to:`/playbooks/skills/${n.name}`,children:"Read playbook →"})]})}function za({command:e,install:n}){return s.jsxs("article",{className:`${o.card} ${o.cardCommand}`,"data-playbook-kind":"command","data-testid":"opencode-playbook-command-card",children:[s.jsxs("div",{className:o.cardTop,children:[s.jsxs("span",{className:`${o.type} ${o.typeCommand}`,children:[s.jsx(ie,{"aria-hidden":"true",size:10})," Command · human-invoked"]}),s.jsx("span",{className:o.meta,children:e.subtask?"subtask":"session"})]}),s.jsx(U,{install:n,installed:n.installedCommands.has(e.name),kind:"command"}),s.jsx("h2",{className:o.cardTitle,children:ye(e.name,e.takesArguments)}),s.jsx("p",{className:o.cardCopy,children:e.description}),s.jsxs("div",{className:o.cardTags,children:[e.runsShell&&s.jsx("span",{children:"shell input"}),e.relatedSkills.map(t=>s.jsx("span",{children:t},t))]}),s.jsx(D,{className:o.cardLink,"data-testid":`opencode-playbook-command-${e.name}`,to:`/playbooks/commands/${e.name}`,children:"Read command →"})]})}const Ya=[{kind:"all",label:"All",href:"/playbooks"},{kind:"skills",label:"Skills",href:"/playbooks/skills"},{kind:"commands",label:"Commands",href:"/playbooks/commands"}];function F({kind:e}){const n=e==="skills"?Ee:Ie;return s.jsxs("section",{className:o.locations,"aria-labelledby":`${e}-locations-heading`,children:[s.jsx("div",{className:o.eyebrow,children:"Install locations"}),s.jsxs("h2",{className:o.sectionTitle,id:`${e}-locations-heading`,children:["Where ",e," live"]}),s.jsx("p",{children:e==="skills"?"Skills are portable directories read by several agent families. Global paths apply everywhere; project paths travel with one repository.":"Commands are individual OpenCode markdown files. They cost no context until a human invokes them."}),s.jsx("div",{className:o.tableWrap,children:s.jsxs("table",{className:o.table,children:[s.jsx("thead",{children:s.jsxs("tr",{children:[s.jsx("th",{scope:"col",children:"Path"}),s.jsx("th",{scope:"col",children:"Scope"}),s.jsx("th",{scope:"col",children:"Read by"})]})}),s.jsx("tbody",{children:n.map(t=>s.jsxs("tr",{children:[s.jsx("th",{scope:"row",children:t.path}),s.jsx("td",{children:t.scope}),s.jsxs("td",{children:[t.readBy,s.jsx("span",{children:t.note})]})]},t.path))})]})})]})}function Xa({kind:e="all",detail:n}){var m;const[t,a]=f.useState(""),i=f.useRef(null),d=f.useRef(null),r=((m=B().state)==null?void 0:m.focusCatalog)===!0;f.useEffect(()=>{var l;r&&((l=d.current)==null||l.focus())},[r]);const h=wt(),c=f.useMemo(()=>e==="commands"?[]:qe(T,t),[e,t]),u=f.useMemo(()=>e==="skills"?[]:xe(S,t),[e,t]),p=f.useMemo(()=>Le(T),[]),w=c.length+u.length,y=l=>{var k;a(l),(k=i.current)==null||k.focus()};return s.jsxs("main",{className:o.page,"data-testid":"opencode-playbooks",ref:d,tabIndex:-1,children:[s.jsxs("div",{className:o.content,children:[s.jsx(ne,{className:o.wipWarning,"data-testid":"opencode-playbooks-wip-warning",variant:"warning",children:"Playbooks is still work in progress and its UI/UX may contain bugs."}),s.jsxs("header",{className:o.hero,children:[s.jsxs("div",{children:[s.jsx("div",{className:o.eyebrow,children:"Repository-owned agent procedures"}),s.jsx("h1",{children:"Repeatable ways to work with an agent."}),s.jsx("p",{className:o.lede,children:"Skills are selected by the model. Commands are invoked by a human. Guided workflows can join them here later without turning one content type into the whole product."})]}),s.jsxs("aside",{className:o.typeStats,"aria-label":"Playbook types",children:[s.jsxs("div",{className:o.typeStat,children:[s.jsx("strong",{children:T.length}),s.jsx("span",{children:"Skills"})]}),s.jsxs("div",{className:o.typeStat,children:[s.jsx("strong",{children:S.length}),s.jsx("span",{children:"Commands"})]}),s.jsxs("div",{className:o.typeStat,children:[s.jsx("strong",{children:"Next"}),s.jsx("span",{children:"Workflows"})]})]})]}),s.jsxs("section",{className:o.catalog,"aria-labelledby":"playbook-catalog-heading",children:[s.jsxs("div",{className:o.catalogHead,children:[s.jsxs("div",{children:[s.jsx("div",{className:o.eyebrow,children:"Catalogue"}),s.jsxs("h2",{className:o.sectionTitle,id:"playbook-catalog-heading",children:[w," matching playbooks ",s.jsx("span",{className:o.count,children:e})]})]}),s.jsxs("label",{className:o.filter,children:[s.jsx(te,{"aria-hidden":"true",size:14}),s.jsx("span",{className:o.filterLabel,children:"filter"}),s.jsx("input",{className:o.filterInput,"data-testid":"opencode-playbook-filter",onChange:l=>a(l.target.value),placeholder:"name, tag, or trigger phrase",ref:i,type:"search",value:t}),t&&s.jsx("button",{"aria-label":"Clear filter",className:o.clear,"data-testid":"opencode-playbook-filter-clear",onClick:()=>{var l;a(""),(l=i.current)==null||l.focus()},type:"button",children:"×"})]})]}),s.jsx("nav",{className:o.tabs,"aria-label":"Playbook types",children:Ya.map(l=>s.jsx(D,{className:`${o.tab} ${l.kind===e?o.tabActive:""}`,"data-testid":`opencode-playbook-kind-${l.kind}`,to:l.href,children:l.label},l.kind))}),e!=="commands"&&s.jsxs("div",{className:o.tags,children:[s.jsx("span",{children:"try:"}),p.map(l=>s.jsxs("button",{className:o.tag,"data-testid":"opencode-playbook-hero-tag",onClick:()=>y(l),type:"button",children:["#",l]},l))]}),w?s.jsxs("div",{className:o.grid,children:[c.map(l=>s.jsx(Ka,{install:h,onTag:y,skill:l},l.name)),u.map(l=>s.jsx(za,{command:l,install:h},l.name))]}):s.jsxs("p",{className:o.empty,children:["No playbook matches ",s.jsx("code",{children:t.trim()}),"."]})]}),e==="skills"&&s.jsx(F,{kind:"skills"}),e==="commands"&&s.jsx(F,{kind:"commands"})]}),n]})}const ss=Object.freeze(Object.defineProperty({__proto__:null,InstallState:U,PlaybooksPage:Xa},Symbol.toStringTag,{value:"Module"}));export{U as I,Xa as P,mt as a,es as b,Za as c,ts as d,Ja as e,ns as f,ss as g,ye as i,as as p,o as s,wt as u};
