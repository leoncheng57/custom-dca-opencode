import{c as D,d as P,r as b,e as z,D as K,f as O,j as n,A as $,L as k,S as Y,g as X}from"./index-BJu8bjsf.js";/**
...
`),i={};let d=null,c=null;for(let h=0;h<r.length;h+=1){const p=r[h];if(p.trim()===""||p.trimStart().startsWith("#"))continue;const y=p.match(A);if(y&&d){const g=i[d];Array.isArray(g)&&g.push(I(y[2]));continue}const w=p.match(C);if(!w){d=null,c=null;continue}const[,u,m,f]=w,v=u.length>0;if(v&&!c)continue;v||(c=null,d=null);const E=f.trim(),T=E.match(ne);if(T){const{value:g,endIndex:V}=oe(r,h,u.length,T[1],ie(T));h=V,v&&c?i[c][m]=g:i[m]=g;continue}if(E===""){const g=re(r,h);if(g&&A.test(g)&&_(g)>=u.length){i[m]=[],d=m,c=null;continue}if(g&&_(g)>u.length&&C.test(g)){i[m]={},c=m,d=null;continue}v&&c?i[c][m]="":i[m]="";continue}if(v&&c){i[c][m]=I(f);continue}i[m]=te(f),d=null}return{data:i,content:l}}function de(e){return e.replace(/^\s*#\s+.+?(\n+|$)/,"")}const le=/\$ARGUMENTS\b|\$[1-9]\b/,he=/!`[^`]+`/;function F(e){return/^[a-z0-9]+(?:-[a-z0-9]+)*$/.test(e)}function L(e){const t=e.split("/").filter(Boolean).pop()??"";return t.endsWith(".md")?t.slice(0,-3):""}function ue(e,t){return t?`/${e} <arguments>`:`/${e}`}function pe(e,t,a={}){const s=L(e);if(!F(s))return null;const{data:r,content:l}=M(t),i=l.trim(),d=(r.description??"").trim();return i===""?null:{name:s,description:d,agent:r.agent,model:r.model,subtask:r.subtask===!0,body:i,takesArguments:le.test(i),runsShell:he.test(i),...a.simulation?{simulation:a.simulation}:{},bytes:typeof TextEncoder>"u"?t.length:new TextEncoder().encode(t).length}}function me(e,t={}){return Object.entries(e).map(([a,s])=>{var r;return pe(a,s,{simulation:(r=t.simulations)==null?void 0:r.get(L(a))})}).filter(a=>a!==null).sort((a,s)=>a.name.localeCompare(s.name))}function ge(e,t){const a=t.trim().toLowerCase();return a===""?e:e.filter(s=>[s.name,s.description,s.body].join(" ").toLowerCase().includes(a))}const fe="leoncheng57",be="custom-dca-opencode",B=`${fe}/${be}`,ye=`https://github.com/${B}`,N="agent-skills",we="main";function la(e){if(!F(e))throw new Error(`Invalid command name: ${e}`);const t=`https://raw.githubusercontent.com/${B}/${we}/${N}/commands/${e}.md`;return[{id:"curl-global",label:"curl",scope:"global",note:"Recommended. Available in every project you open with OpenCode.",command:["mkdir -p ~/.config/opencode/commands && \\",`curl -sL ${t} \\`,`  -o ~/.config/opencode/commands/${e}.md`].join(`
...
`)},{id:"symlink",label:"clone + symlink",scope:"global",note:"Stays updatable: git pull in the clone refreshes the live command.",command:[`git clone ${ye}.git ~/src/custom-dca-opencode   # once`,"mkdir -p ~/.config/opencode/commands",`ln -s ~/src/custom-dca-opencode/${N}/commands/${e}.md \\`,`      ~/.config/opencode/commands/${e}.md`].join(`
`)}]}const ve=[{path:"~/.config/opencode/commands/<name>.md",scope:"Global",readBy:"OpenCode",note:"Every project. Start here."},{path:".opencode/commands/<name>.md",scope:"Project",readBy:"OpenCode",note:"Committed with the repo; loads only inside it."},{path:".claude/commands/<name>.md",scope:"Project",readBy:"Claude Code",note:"Different frontmatter dialect (argument-hint, allowed-tools). Not shipped here."}],ke=`---
...
`,mn=["user","assistant","tool","note"],gn=/^##[ \t]+([a-z]+)(?:[ \t]+—[ \t]*(.*))?[ \t]*$/,fn=/^[ \t]{0,3}(`{3,}|~{3,})(.*)$/;function bn(e){return mn.includes(e)}function yn(e){const t=[];let a=null,s=null;for(const r of e.split(`
`)){const l=r.match(fn);if(l){const[,d,c]=l;s===null?s=d:d[0]===s[0]&&d.length>=s.length&&c.trim()===""&&(s=null),a==null||a.lines.push(r);continue}const i=s===null?r.match(gn):null;if(i){const[,d,c]=i;if(!bn(d))return null;a={role:d,label:(c==null?void 0:c.trim())||void 0,lines:[]},t.push(a);continue}if(a){a.lines.push(r);continue}if(r.trim()!=="")return null}return t}function wn(e){const{data:t,content:a}=M(e),s=(t.title??"").trim(),r=(t.trigger??"").trim(),l=(t.caveat??"").trim();if(s===""||r===""||l==="")return null;const i=yn(de(a));if(i===null||i.length===0||i[0].role!=="user")return null;const d=i.map(c=>({...c,body:c.lines.join(`
`).trim()})).filter(c=>c.body!=="").map(({role:c,label:h,body:p})=>h===void 0?{role:c,body:p}:{role:c,label:h,body:p});return d.length===0?null:{title:s,trigger:r,caveat:l,turns:d}}function vn(e){const t=new Map;for(const[a,s]of Object.entries(e)){const r=a.split("/").filter(Boolean),l=r.length>1?r.at(-2)??"":"",i=l===""?null:wn(s);i&&t.set(l,i)}return t}const kn=Object.assign({"../../agent-skills/commands/background.md":ke,"../../agent-skills/commands/build-waves.md":_e,"../../agent-skills/commands/cite-file-lines.md":xe,"../../agent-skills/commands/dca.md":Te,"../../agent-skills/commands/deep-research.md":Re,"../../agent-skills/commands/diagram.md":Se,"../../agent-skills/commands/docs-preview.md":Ee,"../../agent-skills/commands/duck-mode.md":Ce,"../../agent-skills/commands/goal.md":Ae,"../../agent-skills/commands/grill-me.md":Ie,"../../agent-skills/commands/handoff.md":Ne,"../../agent-skills/commands/leaving-now-wrap-up.md":je,"../../agent-skills/commands/manager-children.md":De,"../../agent-skills/commands/mini-design-doc.md":Pe,"../../agent-skills/commands/native-worktree-subagents.md":Oe,"../../agent-skills/commands/red-team.md":$e,"../../agent-skills/commands/research-handoff.md":qe,"../../agent-skills/commands/review-learning.md":Ue,"../../agent-skills/commands/session-handoff.md":Me,"../../agent-skills/commands/standup.md":Fe,"../../agent-skills/commands/system-design-artifacts.md":Le,"../../agent-skills/commands/verify.md":Be,"../../agent-skills/commands/worktree-up.md":We}),_n=Object.assign({"../../agent-skills/command-simulations/background.md":Ge,"../../agent-skills/command-simulations/build-waves.md":He,"../../agent-skills/command-simulations/cite-file-lines.md":Ve,"../../agent-skills/command-simulations/dca.md":ze,"../../agent-skills/command-simulations/deep-research.md":Ke,"../../agent-skills/command-simulations/diagram.md":Ye,"../../agent-skills/command-simulations/docs-preview.md":Xe,"../../agent-skills/command-simulations/duck-mode.md":Qe,"../../agent-skills/command-simulations/goal.md":Je,"../../agent-skills/command-simulations/grill-me.md":Ze,"../../agent-skills/command-simulations/handoff.md":en,"../../agent-skills/command-simulations/leaving-now-wrap-up.md":nn,"../../agent-skills/command-simulations/manager-children.md":tn,"../../agent-skills/command-simulations/mini-design-doc.md":an,"../../agent-skills/command-simulations/native-worktree-subagents.md":sn,"../../agent-skills/command-simulations/red-team.md":on,"../../agent-skills/command-simulations/research-handoff.md":rn,"../../agent-skills/command-simulations/review-learning.md":cn,"../../agent-skills/command-simulations/session-handoff.md":dn,"../../agent-skills/command-simulations/standup.md":ln,"../../agent-skills/command-simulations/system-design-artifacts.md":hn,"../../agent-skills/command-simulations/verify.md":un,"../../agent-skills/command-simulations/worktree-up.md":pn});function xn(e){return Object.fromEntries(Object.entries(e).map(([t,a])=>{var r;return[`commands/${((r=t.split("/").pop())==null?void 0:r.replace(/\.md$/u,""))??""}/SIMULATION.md`,a]}))}const S=me(kn,{simulations:vn(xn(_n))});function ha(e){return S.find(t=>t.name===e)}const Tn="https://github.com/leoncheng57/custom-dca-opencode",Rn="main",j=`${Tn}/blob/${Rn}/agent-skills`,ua={command:e=>`${j}/commands/${e}.md`,commandSimulation:e=>`${j}/command-simulations/${e}.md`},W={status:"unknown",directoryLabel:"",installedCommands:new Set},R=W;function Sn(e){const t=e.replace(/\/+$/u,"");return t.slice(t.lastIndexOf("/")+1)||t}function En(e,t){return!e||!t?W:{status:"ready",directoryLabel:Sn(e),installedCommands:new Set(t.commands.map(a=>a.name))}}function Cn(){const e=P(),[t,a]=b.useState(R);return b.useEffect(()=>{const s=z(e.search,typeof localStorage>"u"?null:localStorage.getItem(K));if(!s){a(R);return}const r=new AbortController;let l=!1;return O.catalog(s,r.signal).then(i=>{l||a(En(s,i))}).catch(()=>{l||a(R)}),()=>{l=!0,r.abort()}},[e.search]),t}const An="_page_nt2c5_1",In="_content_nt2c5_8",Nn="_wipWarning_nt2c5_14",jn="_eyebrow_nt2c5_16",Dn="_type_nt2c5_16",Pn="_filterLabel_nt2c5_16",On="_filterInput_nt2c5_16",$n="_meta_nt2c5_16",qn="_source_nt2c5_16",Un="_terminal_nt2c5_16",Mn="_methodScope_nt2c5_16",Fn="_hero_nt2c5_20",Ln="_modalTitle_nt2c5_37",Bn="_cardTitle_nt2c5_37",Wn="_sectionTitle_nt2c5_37",Gn="_lede_nt2c5_42",Hn="_typeStats_nt2c5_44",Vn="_typeStat_nt2c5_44",zn="_catalog_nt2c5_49",Kn="_catalogHead_nt2c5_50",Yn="_catalogHeading_nt2c5_51",Xn="_categoryNav_nt2c5_53",Qn="_filter_nt2c5_16",Jn="_clear_nt2c5_60",Zn="_cardLink_nt2c5_61",et="_grid_nt2c5_64",nt="_card_nt2c5_37",tt="_cardTop_nt2c5_66",at="_typeCommand_nt2c5_67",st="_typeWorkflow_nt2c5_68",ot="_loadState_nt2c5_71",it="_loadStateOn_nt2c5_72",rt="_loadStateOff_nt2c5_73",ct="_scopeNote_nt2c5_74",dt="_cardCommand_nt2c5_75",lt="_cardWorkflow_nt2c5_76",ht="_cardCopy_nt2c5_77",ut="_cardTags_nt2c5_77",pt="_empty_nt2c5_78",mt="_workflowState_nt2c5_79",gt="_workflowGroup_nt2c5_80",ft="_injectorPreview_nt2c5_81",bt="_injectorDetail_nt2c5_81",yt="_locations_nt2c5_83",wt="_tableWrap_nt2c5_83",vt="_table_nt2c5_83",kt="_dialog_nt2c5_85",_t="_dialogBody_nt2c5_86",xt="_close_nt2c5_86",Tt="_modalHead_nt2c5_87",Rt="_modalDescription_nt2c5_87",St="_route_nt2c5_87",Et="_detailGrid_nt2c5_88",Ct="_side_nt2c5_88",At="_terminalBar_nt2c5_91",It="_light_nt2c5_91",Nt="_terminalPath_nt2c5_91",jt="_terminalSource_nt2c5_91",Dt="_terminalTurns_nt2c5_91",Pt="_turn_nt2c5_91",Ot="_turnRole_nt2c5_91",$t="_turnAssistant_nt2c5_91",qt="_turnTool_nt2c5_91",Ut="_turnNote_nt2c5_91",Mt="_terminalControls_nt2c5_95",Ft="_terminalButton_nt2c5_95",Lt="_terminalButtonPrimary_nt2c5_95",Bt="_terminalStatus_nt2c5_95",Wt="_progress_nt2c5_95",Gt="_terminalCaveat_nt2c5_95",Ht="_disclosures_nt2c5_97",Vt="_disclosure_nt2c5_97",zt="_disclosureMeta_nt2c5_97",Kt="_disclosureBody_nt2c5_97",Yt="_descriptionPanel_nt2c5_97",Xt="_descriptionBar_nt2c5_97",Qt="_descriptionBody_nt2c5_97",Jt="_method_nt2c5_16",Zt="_methodHead_nt2c5_97",ea="_methodCopy_nt2c5_97",na="_command_nt2c5_97",ta="_notFound_nt2c5_97",o={page:An,content:In,wipWarning:Nn,eyebrow:jn,type:Dn,filterLabel:Pn,filterInput:On,meta:$n,source:qn,terminal:Un,methodScope:Mn,hero:Fn,modalTitle:Ln,cardTitle:Bn,sectionTitle:Wn,lede:Gn,typeStats:Hn,typeStat:Vn,catalog:zn,catalogHead:Kn,catalogHeading:Yn,categoryNav:Xn,filter:Qn,clear:Jn,cardLink:Zn,grid:et,card:nt,cardTop:tt,typeCommand:at,typeWorkflow:st,loadState:ot,loadStateOn:it,loadStateOff:rt,scopeNote:ct,cardCommand:dt,cardWorkflow:lt,cardCopy:ht,cardTags:ut,empty:pt,workflowState:mt,workflowGroup:gt,injectorPreview:ft,injectorDetail:bt,locations:yt,tableWrap:wt,table:vt,dialog:kt,dialogBody:_t,close:xt,modalHead:Tt,modalDescription:Rt,route:St,detailGrid:Et,side:Ct,terminalBar:At,light:It,terminalPath:Nt,terminalSource:jt,terminalTurns:Dt,turn:Pt,turnRole:Ot,turnAssistant:$t,turnTool:qt,turnNote:Ut,terminalControls:Mt,terminalButton:Ft,terminalButtonPrimary:Lt,terminalStatus:Bt,progress:Wt,terminalCaveat:Gt,disclosures:Ht,disclosure:Vt,disclosureMeta:zt,disclosureBody:Kt,descriptionPanel:Yt,descriptionBar:Xt,descriptionBody:Qt,method:Jt,methodHead:Zt,methodCopy:ea,command:na,notFound:ta};function G(e=!0){const[t,a]=b.useState({status:"loading",workflows:[]});return b.useEffect(()=>{if(!e)return;let s=!1;return a({status:"loading",workflows:[]}),O.workflows().then(({workflows:r})=>{s||a({status:"ready",workflows:r})},()=>{s||a({status:"error",workflows:[]})}),()=>{s=!0}},[e]),t}function H({install:e,installed:t}){return e.status!=="ready"?null:n.jsxs("span",{className:`${o.loadState} ${t?o.loadStateOn:o.loadStateOff}`,"data-installed":t,"data-testid":"opencode-playbook-command-load-state",title:`Reported by the OpenCode server for ${e.directoryLabel}. Installation is per project.`,children:[t?"Loaded":"Not loaded"," in ",e.directoryLabel]})}function aa({command:e,install:t}){return n.jsxs("article",{className:`${o.card} ${o.cardCommand}`,"data-playbook-kind":"command","data-testid":"opencode-playbook-command-card",children:[n.jsxs("div",{className:o.cardTop,children:[n.jsxs("span",{className:`${o.type} ${o.typeCommand}`,children:[n.jsx(ee,{"aria-hidden":"true",size:10})," Command - human-invoked"]}),n.jsx("span",{className:o.meta,children:e.subtask?"subtask":"session"})]}),n.jsx(H,{install:t,installed:t.installedCommands.has(e.name)}),n.jsx("h2",{className:o.cardTitle,children:ue(e.name,e.takesArguments)}),n.jsx("p",{className:o.cardCopy,children:e.description}),n.jsxs("div",{className:o.cardTags,children:[e.runsShell&&n.jsx("span",{children:"shell input"}),e.agent&&n.jsx("span",{children:e.agent})]}),n.jsx(k,{className:o.cardLink,"data-testid":`opencode-playbook-command-${e.name}`,to:`/playbooks/commands/${e.name}`,children:"Read command ->"})]})}function sa({workflow:e,group:t}){return n.jsxs("article",{className:`${o.card} ${o.cardWorkflow}`,"data-playbook-kind":"workflow","data-testid":"opencode-playbook-workflow-card",children:[n.jsxs("div",{className:o.cardTop,children:[n.jsxs("span",{className:`${o.type} ${o.typeWorkflow}`,children:[n.jsx(J,{"aria-hidden":"true",size:10})," Workflow - guided action"]}),n.jsx("span",{className:o.meta,children:t})]}),n.jsx("h2",{className:o.cardTitle,children:e.title}),n.jsx("p",{className:o.cardCopy,children:e.description}),n.jsxs("details",{className:o.injectorPreview,children:[n.jsx("summary",{"data-testid":`opencode-playbook-workflow-injector-${e.id}`,children:"Trusted injector"}),n.jsx("pre",{children:n.jsx("code",{children:e.injector})})]}),n.jsx(k,{className:o.cardLink,"data-testid":`opencode-playbook-workflow-${e.id}`,to:`/playbooks/workflows/${e.id}`,children:"Read workflow ->"})]})}function oa(){return n.jsxs("section",{className:o.locations,"aria-labelledby":"command-locations-heading",children:[n.jsx("div",{className:o.eyebrow,children:"Install locations"}),n.jsx("h2",{className:o.sectionTitle,id:"command-locations-heading",children:"Where commands live"}),n.jsx("p",{children:"Commands are individual OpenCode Markdown files. They add zero retrieval context until a human explicitly invokes one."}),n.jsx("div",{className:o.tableWrap,children:n.jsxs("table",{className:o.table,children:[n.jsx("thead",{children:n.jsxs("tr",{children:[n.jsx("th",{scope:"col",children:"Path"}),n.jsx("th",{scope:"col",children:"Scope"}),n.jsx("th",{scope:"col",children:"Read by"})]})}),n.jsx("tbody",{children:ve.map(e=>n.jsxs("tr",{children:[n.jsx("th",{scope:"row",children:e.path}),n.jsx("td",{children:e.scope}),n.jsxs("td",{children:[e.readBy,n.jsx("span",{children:e.note})]})]},e.path))})]})})]})}function ia({query:e}){const t=Cn(),a=b.useMemo(()=>ge(S,e),[e]);return n.jsxs(n.Fragment,{children:[n.jsxs("div",{className:o.catalogHeading,children:[n.jsx("div",{className:o.eyebrow,children:"Commands"}),n.jsxs("h2",{className:o.sectionTitle,children:[a.length," matching commands"]})]}),a.length?n.jsx("div",{className:o.grid,children:a.map(s=>n.jsx(aa,{command:s,install:t},s.name))}):n.jsxs("p",{className:o.empty,children:["No command matches ",n.jsx("code",{children:e.trim()}),"."]}),n.jsx(oa,{})]})}function ra({commandsRendered:e,query:t,state:a}){if(a.status==="loading")return n.jsx("p",{className:o.empty,"data-testid":"opencode-playbook-workflows-loading",children:"Loading workflows..."});if(a.status==="error")return n.jsxs($,{className:o.workflowState,"data-testid":"opencode-playbook-workflows-error",variant:"danger",children:["Workflows could not be loaded. ",e?"Commands remain available.":"Try again after the catalogue is available."]});const s=t.trim().toLowerCase(),r=X(a.workflows).map(({label:i,workflows:d})=>({label:i,workflows:d.filter(c=>!s||`${c.title} ${c.description} ${c.id} ${c.injector}`.toLowerCase().includes(s))})).filter(({workflows:i})=>i.length),l=r.reduce((i,d)=>i+d.workflows.length,0);return n.jsxs("div",{"data-testid":"opencode-playbook-workflows-ready",children:[n.jsxs("div",{className:o.catalogHeading,children:[n.jsx("div",{className:o.eyebrow,children:"Workflows"}),n.jsxs("h2",{className:o.sectionTitle,children:[l," matching workflows"]})]}),a.workflows.length===0?n.jsx("p",{className:o.empty,"data-testid":"opencode-playbook-workflows-empty",children:"No workflows are available."}):l===0?n.jsxs("p",{className:o.empty,children:["No workflow matches ",n.jsx("code",{children:t.trim()}),"."]}):r.map(({label:i,workflows:d})=>n.jsxs("section",{"aria-labelledby":`workflow-group-${i.toLowerCase()}`,className:o.workflowGroup,"data-testid":"opencode-playbook-workflow-group",children:[n.jsx("h3",{id:`workflow-group-${i.toLowerCase()}`,children:i}),n.jsx("div",{className:o.grid,children:d.map(c=>n.jsx(sa,{group:i,workflow:c},c.id))})]},i))]})}function ca({detail:e,workflowState:t}){var m;const[a,s]=b.useState(""),r=b.useRef(null),l=b.useRef(null),i=P(),d=((m=i.state)==null?void 0:m.focusCatalog)===!0,c=i.pathname.startsWith("/playbooks/commands"),h=i.pathname.startsWith("/playbooks/workflows"),p=!h,y=!c,w=G(y&&t===void 0),u=t??w;return b.useEffect(()=>{var f;d&&((f=l.current)==null||f.focus())},[d]),n.jsxs("main",{className:o.page,"data-testid":"opencode-playbooks",ref:l,tabIndex:-1,children:[n.jsxs("div",{className:o.content,children:[n.jsx($,{className:o.wipWarning,"data-testid":"opencode-playbooks-wip-warning",variant:"warning",children:"Playbooks is still work in progress and its UI/UX may contain bugs."}),n.jsxs("header",{className:o.hero,children:[n.jsxs("div",{children:[n.jsx("div",{className:o.eyebrow,children:"Commands and live workflows"}),n.jsx("h1",{children:"Repeatable work, invoked on purpose."}),n.jsx("p",{className:o.lede,children:"Commands are repository-owned procedures. Workflows are guided actions loaded live from the trusted server catalogue; runtime reminders remain a separate per-message mechanism."})]}),n.jsxs("aside",{className:o.typeStats,"aria-label":"Playbook types",children:[n.jsxs("div",{className:o.typeStat,children:[n.jsx("strong",{children:S.length}),n.jsx("span",{children:"Commands"})]}),n.jsxs("div",{className:o.typeStat,children:[n.jsx("strong",{children:u.status==="ready"?u.workflows.length:"-"}),n.jsx("span",{children:"Workflows"})]}),n.jsxs("div",{className:o.typeStat,children:[n.jsx("strong",{children:"0"}),n.jsx("span",{children:"At-rest tokens"})]})]})]}),n.jsxs("nav",{"aria-label":"Playbook categories",className:o.categoryNav,children:[n.jsx(k,{"aria-current":!c&&!h?"page":void 0,"data-testid":"opencode-playbooks-all",to:"/playbooks",children:"All"}),n.jsx(k,{"aria-current":c?"page":void 0,"data-testid":"opencode-playbooks-commands",to:"/playbooks/commands",children:"Commands"}),n.jsx(k,{"aria-current":h?"page":void 0,"data-testid":"opencode-playbooks-workflows",to:"/playbooks/workflows",children:"Workflows"})]}),n.jsxs("section",{className:o.catalog,"aria-labelledby":"playbook-catalog-heading",children:[n.jsxs("div",{className:o.catalogHead,children:[n.jsxs("div",{children:[n.jsx("div",{className:o.eyebrow,children:"Catalogue"}),n.jsx("h2",{className:o.sectionTitle,id:"playbook-catalog-heading",children:c?"Commands":h?"Workflows":"All Playbooks"})]}),n.jsxs("label",{className:o.filter,children:[n.jsx(Y,{"aria-hidden":"true",size:14}),n.jsx("span",{className:o.filterLabel,children:"filter"}),n.jsx("input",{className:o.filterInput,"data-testid":"opencode-playbook-filter",onChange:f=>s(f.target.value),placeholder:"name, description, or instruction",ref:r,type:"search",value:a}),a&&n.jsx("button",{"aria-label":"Clear filter",className:o.clear,"data-testid":"opencode-playbook-filter-clear",onClick:()=>{var f;s(""),(f=r.current)==null||f.focus()},type:"button",children:"x"})]})]}),p&&n.jsx(ia,{query:a}),y&&n.jsx(ra,{commandsRendered:p,query:a,state:u})]})]}),e]})}const pa=Object.freeze(Object.defineProperty({__proto__:null,InstallState:H,PlaybooksPage:ca,useWorkflowCatalogue:G},Symbol.toStringTag,{value:"Module"}));export{H as I,ca as P,Rn as a,G as b,la as c,pa as d,ha as f,ue as i,ua as p,o as s,Cn as u};
