...
`,Cn=["user","assistant","tool","note"],Nn=/^##[ \t]+([a-z]+)(?:[ \t]+—[ \t]*(.*))?[ \t]*$/,Dn=/^[ \t]{0,3}(`{3,}|~{3,})(.*)$/;function Pn(e){return Cn.includes(e)}function On(e){const n=[];let t=null,a=null;for(const i of e.split(`
`)){const h=i.match(Dn);if(h){const[,c,d]=h;a===null?a=c:c[0]===a[0]&&c.length>=a.length&&d.trim()===""&&(a=null),t==null||t.lines.push(i);continue}const r=a===null?i.match(Nn):null;if(r){const[,c,d]=r;if(!Pn(c))return null;t={role:c,label:(d==null?void 0:d.trim())||void 0,lines:[]},n.push(t);continue}if(t){t.lines.push(i);continue}if(i.trim()!=="")return null}return n}function Un(e){const{data:n,content:t}=D(e),a=(n.title??"").trim(),i=(n.trigger??"").trim(),h=(n.caveat??"").trim();if(a===""||i===""||h==="")return null;const r=On($(t));if(r===null||r.length===0||r[0].role!=="user")return null;const c=r.map(d=>({...d,body:d.lines.join(`
`).trim()})).filter(d=>d.body!=="").map(({role:d,label:u,body:l})=>u===void 0?{role:d,body:l}:{role:d,label:u,body:l});return c.length===0?null:{title:a,trigger:i,caveat:h,turns:c}}function H(e){const n=new Map;for(const[t,a]of Object.entries(e)){const i=P(t),h=i===""?null:Un(a);h&&n.set(i,h)}return n}const jn=Object.assign({"../../agent-skills/skills/ascii-diagrams/SKILL.md":Re,"../../agent-skills/skills/background-subagent/SKILL.md":Ae,"../../agent-skills/skills/build-waves/SKILL.md":Se,"../../agent-skills/skills/deep-research-subagents/SKILL.md":Ce,"../../agent-skills/skills/docs-and-diagram-tooling/SKILL.md":Ne,"../../agent-skills/skills/duck-mode/SKILL.md":De,"../../agent-skills/skills/grill-me/SKILL.md":Pe,"../../agent-skills/skills/human-verification-steps/SKILL.md":Oe,"../../agent-skills/skills/manager-children/SKILL.md":Ue,"../../agent-skills/skills/parallel-research-handoff/SKILL.md":je,"../../agent-skills/skills/red-team-this/SKILL.md":Le,"../../agent-skills/skills/session-handoff/SKILL.md":qe,"../../agent-skills/skills/worktree-up/SKILL.md":Me}),Ln=Object.assign({"../../agent-skills/skills/ascii-diagrams/SIMULATION.md":Fe,"../../agent-skills/skills/background-subagent/SIMULATION.md":We,"../../agent-skills/skills/build-waves/SIMULATION.md":$e,"../../agent-skills/skills/deep-research-subagents/SIMULATION.md":Be,"../../agent-skills/skills/docs-and-diagram-tooling/SIMULATION.md":Ge,"../../agent-skills/skills/duck-mode/SIMULATION.md":He,"../../agent-skills/skills/grill-me/SIMULATION.md":Ve,"../../agent-skills/skills/human-verification-steps/SIMULATION.md":Ke,"../../agent-skills/skills/manager-children/SIMULATION.md":ze,"../../agent-skills/skills/parallel-research-handoff/SIMULATION.md":Ye,"../../agent-skills/skills/red-team-this/SIMULATION.md":Xe,"../../agent-skills/skills/session-handoff/SIMULATION.md":Qe,"../../agent-skills/skills/worktree-up/SIMULATION.md":Ze}),qn=Object.assign({"../../agent-skills/commands/background.md":Je,"../../agent-skills/commands/build-waves.md":en,"../../agent-skills/commands/deep-research.md":nn,"../../agent-skills/commands/diagram.md":tn,"../../agent-skills/commands/docs-preview.md":an,"../../agent-skills/commands/duck-mode.md":sn,"../../agent-skills/commands/grill-me.md":on,"../../agent-skills/commands/handoff.md":rn,"../../agent-skills/commands/manager-children.md":ln,"../../agent-skills/commands/red-team.md":dn,"../../agent-skills/commands/research-handoff.md":hn,"../../agent-skills/commands/session-handoff.md":cn,"../../agent-skills/commands/standup.md":un,"../../agent-skills/commands/verify.md":pn,"../../agent-skills/commands/worktree-up.md":mn}),Mn=Object.assign({"../../agent-skills/command-simulations/background.md":gn,"../../agent-skills/command-simulations/build-waves.md":fn,"../../agent-skills/command-simulations/deep-research.md":wn,"../../agent-skills/command-simulations/diagram.md":bn,"../../agent-skills/command-simulations/docs-preview.md":yn,"../../agent-skills/command-simulations/duck-mode.md":kn,"../../agent-skills/command-simulations/grill-me.md":vn,"../../agent-skills/command-simulations/handoff.md":xn,"../../agent-skills/command-simulations/manager-children.md":Tn,"../../agent-skills/command-simulations/red-team.md":_n,"../../agent-skills/command-simulations/research-handoff.md":In,"../../agent-skills/command-simulations/session-handoff.md":En,"../../agent-skills/command-simulations/standup.md":Rn,"../../agent-skills/command-simulations/verify.md":An,"../../agent-skills/command-simulations/worktree-up.md":Sn});function Fn(e){return Object.fromEntries(Object.entries(e).map(([n,t])=>{var i;return[`commands/${((i=n.split("/").pop())==null?void 0:i.replace(/\.md$/u,""))??""}/SIMULATION.md`,t]}))}const x=_e(jn,H(Ln)),R=de(qn,{skillNames:new Set(x.map(e=>e.name)),simulations:H(Fn(Mn))});function fa(e){return x.find(n=>n.name===e)}function wa(e){return R.find(n=>n.name===e)}function ba(e){return R.find(n=>n.relatedSkills.length===1&&n.relatedSkills[0]===e)}const Wn="https://github.com/leoncheng57/custom-dca-opencode",_=`${Wn}/blob/main/agent-skills`,ya={skill:e=>`${_}/skills/${e}/SKILL.md`,skillSimulation:e=>`${_}/skills/${e}/SIMULATION.md`,command:e=>`${_}/commands/${e}.md`,commandSimulation:e=>`${_}/command-simulations/${e}.md`},$n="_page_1680g_1",Bn="_content_1680g_8",Gn="_wipWarning_1680g_14",Hn="_eyebrow_1680g_16",Vn="_type_1680g_16",Kn="_count_1680g_16",zn="_filterLabel_1680g_16",Yn="_filterInput_1680g_16",Xn="_tag_1680g_16",Qn="_meta_1680g_16",Zn="_source_1680g_16",Jn="_terminal_1680g_16",et="_methodScope_1680g_16",nt="_hero_1680g_20",tt="_modalTitle_1680g_37",at="_cardTitle_1680g_37",st="_sectionTitle_1680g_37",ot="_lede_1680g_42",it="_typeStats_1680g_44",rt="_typeStat_1680g_44",lt="_catalog_1680g_49",dt="_catalogHead_1680g_50",ht="_filter_1680g_16",ct="_clear_1680g_57",ut="_tab_1680g_58",pt="_cardLink_1680g_58",mt="_tabs_1680g_60",gt="_tags_1680g_60",ft="_tabActive_1680g_64",wt="_grid_1680g_68",bt="_card_1680g_37",yt="_cardTop_1680g_70",kt="_cardCopy_1680g_71",vt="_cardTags_1680g_71",xt="_empty_1680g_72",Tt="_locations_1680g_74",_t="_tableWrap_1680g_74",It="_table_1680g_74",Et="_dialog_1680g_76",Rt="_dialogBody_1680g_77",At="_close_1680g_77",St="_modalHead_1680g_78",Ct="_modalDescription_1680g_78",Nt="_route_1680g_78",Dt="_detailGrid_1680g_79",Pt="_side_1680g_79",Ot="_note_1680g_79",Ut="_terminalBar_1680g_81",jt="_light_1680g_81",Lt="_terminalPath_1680g_81",qt="_terminalSource_1680g_81",Mt="_terminalTurns_1680g_81",Ft="_turn_1680g_81",Wt="_turnRole_1680g_81",$t="_turnAssistant_1680g_81",Bt="_turnTool_1680g_81",Gt="_turnNote_1680g_81",Ht="_terminalControls_1680g_81",Vt="_terminalButton_1680g_81",Kt="_terminalButtonPrimary_1680g_81",zt="_terminalStatus_1680g_81",Yt="_progress_1680g_81",Xt="_disclosures_1680g_83",Qt="_disclosure_1680g_83",Zt="_disclosureMeta_1680g_83",Jt="_disclosureBody_1680g_83",ea="_descriptionPanel_1680g_83",na="_descriptionBar_1680g_83",ta="_descriptionBody_1680g_83",aa="_relation_1680g_83",sa="_method_1680g_16",oa="_methodHead_1680g_83",ia="_methodCopy_1680g_83",ra="_command_1680g_83",la="_notFound_1680g_83",o={page:$n,content:Bn,wipWarning:Gn,eyebrow:Hn,type:Vn,count:Kn,filterLabel:zn,filterInput:Yn,tag:Xn,meta:Qn,source:Zn,terminal:Jn,methodScope:et,hero:nt,modalTitle:tt,cardTitle:at,sectionTitle:st,lede:ot,typeStats:it,typeStat:rt,catalog:lt,catalogHead:dt,filter:ht,clear:ct,tab:ut,cardLink:pt,tabs:mt,tags:gt,tabActive:ft,grid:wt,card:bt,cardTop:yt,cardCopy:kt,cardTags:vt,empty:xt,locations:Tt,tableWrap:_t,table:It,dialog:Et,dialogBody:Rt,close:At,modalHead:St,modalDescription:Ct,route:Nt,detailGrid:Dt,side:Pt,note:Ot,terminalBar:Ut,light:jt,terminalPath:Lt,terminalSource:qt,terminalTurns:Mt,turn:Ft,turnRole:Wt,turnAssistant:$t,turnTool:Bt,turnNote:Gt,terminalControls:Ht,terminalButton:Vt,terminalButtonPrimary:Kt,terminalStatus:zt,progress:Yt,disclosures:Xt,disclosure:Qt,disclosureMeta:Zt,disclosureBody:Jt,descriptionPanel:ea,descriptionBar:na,descriptionBody:ta,relation:aa,method:sa,methodHead:oa,methodCopy:ia,command:ra,notFound:la};function da({skill:e,onTag:n}){return s.jsxs("article",{className:o.card,"data-testid":"opencode-playbook-skill-card",children:[s.jsxs("div",{className:o.cardTop,children:[s.jsx("span",{className:o.type,children:"Skill"}),s.jsxs("span",{className:o.meta,children:[e.readingTimeMinutes," min"]})]}),s.jsx("h2",{className:o.cardTitle,children:e.title}),s.jsx("p",{className:o.cardCopy,children:e.summary}),s.jsx("div",{className:o.cardTags,children:e.tags.map(t=>s.jsxs("button",{className:o.tag,"data-testid":"opencode-playbook-tag",onClick:()=>n(t),type:"button",children:["#",t]},t))}),s.jsx(N,{className:o.cardLink,"data-testid":`opencode-playbook-skill-${e.name}`,to:`/playbooks/skills/${e.name}`,children:"Read playbook →"})]})}function ha({command:e}){return s.jsxs("article",{className:o.card,"data-testid":"opencode-playbook-command-card",children:[s.jsxs("div",{className:o.cardTop,children:[s.jsx("span",{className:o.type,children:"Command"}),s.jsx("span",{className:o.meta,children:e.subtask?"subtask":"session"})]}),s.jsx("h2",{className:o.cardTitle,children:re(e.name,e.takesArguments)}),s.jsx("p",{className:o.cardCopy,children:e.description}),s.jsxs("div",{className:o.cardTags,children:[e.runsShell&&s.jsx("span",{children:"shell input"}),e.relatedSkills.map(n=>s.jsx("span",{children:n},n))]}),s.jsx(N,{className:o.cardLink,"data-testid":`opencode-playbook-command-${e.name}`,to:`/playbooks/commands/${e.name}`,children:"Read command →"})]})}const ca=[{kind:"all",label:"All",href:"/playbooks"},{kind:"skills",label:"Skills",href:"/playbooks/skills"},{kind:"commands",label:"Commands",href:"/playbooks/commands"}];function M({kind:e}){const n=e==="skills"?me:pe;return s.jsxs("section",{className:o.locations,"aria-labelledby":`${e}-locations-heading`,children:[s.jsx("div",{className:o.eyebrow,children:"Install locations"}),s.jsxs("h2",{className:o.sectionTitle,id:`${e}-locations-heading`,children:["Where ",e," live"]}),s.jsx("p",{children:e==="skills"?"Skills are portable directories read by several agent families. Global paths apply everywhere; project paths travel with one repository.":"Commands are individual OpenCode markdown files. They cost no context until a human invokes them."}),s.jsx("div",{className:o.tableWrap,children:s.jsxs("table",{className:o.table,children:[s.jsx("thead",{children:s.jsxs("tr",{children:[s.jsx("th",{scope:"col",children:"Path"}),s.jsx("th",{scope:"col",children:"Scope"}),s.jsx("th",{scope:"col",children:"Read by"})]})}),s.jsx("tbody",{children:n.map(t=>s.jsxs("tr",{children:[s.jsx("th",{scope:"row",children:t.path}),s.jsx("td",{children:t.scope}),s.jsxs("td",{children:[t.readBy,s.jsx("span",{children:t.note})]})]},t.path))})]})})]})}function ua({kind:e="all",detail:n}){const[t,a]=y.useState(""),i=y.useRef(null),h=y.useMemo(()=>e==="commands"?[]:Ie(x,t),[e,t]),r=y.useMemo(()=>e==="skills"?[]:he(R,t),[e,t]),c=y.useMemo(()=>Ee(x),[]),d=h.length+r.length,u=l=>{var f;a(l),(f=i.current)==null||f.focus()};return s.jsxs("main",{className:o.page,"data-testid":"opencode-playbooks",children:[s.jsxs("div",{className:o.content,children:[s.jsx(K,{className:o.wipWarning,"data-testid":"opencode-playbooks-wip-warning",variant:"warning",children:"Playbooks is still work in progress and its UI/UX may contain bugs."}),s.jsxs("header",{className:o.hero,children:[s.jsxs("div",{children:[s.jsx("div",{className:o.eyebrow,children:"Repository-owned agent procedures"}),s.jsx("h1",{children:"Repeatable ways to work with an agent."}),s.jsx("p",{className:o.lede,children:"Skills are selected by the model. Commands are invoked by a human. Guided workflows can join them here later without turning one content type into the whole product."})]}),s.jsxs("aside",{className:o.typeStats,"aria-label":"Playbook types",children:[s.jsxs("div",{className:o.typeStat,children:[s.jsx("strong",{children:x.length}),s.jsx("span",{children:"Skills"})]}),s.jsxs("div",{className:o.typeStat,children:[s.jsx("strong",{children:R.length}),s.jsx("span",{children:"Commands"})]}),s.jsxs("div",{className:o.typeStat,children:[s.jsx("strong",{children:"Next"}),s.jsx("span",{children:"Workflows"})]})]})]}),s.jsxs("section",{className:o.catalog,"aria-labelledby":"playbook-catalog-heading",children:[s.jsxs("div",{className:o.catalogHead,children:[s.jsxs("div",{children:[s.jsx("div",{className:o.eyebrow,children:"Catalogue"}),s.jsxs("h2",{className:o.sectionTitle,id:"playbook-catalog-heading",children:[d," matching playbooks ",s.jsx("span",{className:o.count,children:e})]})]}),s.jsxs("label",{className:o.filter,children:[s.jsx(z,{"aria-hidden":"true",size:14}),s.jsx("span",{className:o.filterLabel,children:"filter"}),s.jsx("input",{className:o.filterInput,"data-testid":"opencode-playbook-filter",onChange:l=>a(l.target.value),placeholder:"name, tag, or trigger phrase",ref:i,type:"search",value:t}),t&&s.jsx("button",{"aria-label":"Clear filter",className:o.clear,onClick:()=>{var l;a(""),(l=i.current)==null||l.focus()},type:"button",children:"×"})]})]}),s.jsx("nav",{className:o.tabs,"aria-label":"Playbook types",children:ca.map(l=>s.jsx(N,{className:`${o.tab} ${l.kind===e?o.tabActive:""}`,to:l.href,children:l.label},l.kind))}),e!=="commands"&&s.jsxs("div",{className:o.tags,children:[s.jsx("span",{children:"try:"}),c.map(l=>s.jsxs("button",{className:o.tag,onClick:()=>u(l),type:"button",children:["#",l]},l))]}),d?s.jsxs("div",{className:o.grid,children:[h.map(l=>s.jsx(da,{onTag:u,skill:l},l.name)),r.map(l=>s.jsx(ha,{command:l},l.name))]}):s.jsxs("p",{className:o.empty,children:["No playbook matches ",s.jsx("code",{children:t.trim()}),"."]})]}),e==="skills"&&s.jsx(M,{kind:"skills"}),e==="commands"&&s.jsx(M,{kind:"commands"})]}),n]})}const ka=Object.freeze(Object.defineProperty({__proto__:null,PlaybooksPage:ua},Symbol.toStringTag,{value:"Module"}));export{ua as P,fa as a,ba as b,ma as c,ga as d,ka as e,wa as f,re as i,ya as p,o as s};
