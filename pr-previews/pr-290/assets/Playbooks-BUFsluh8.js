import{c as $,r as y,b as z,j as s,A as Y,S as X,L as N}from"./index-BrgXF87c.js";/**
 * @license lucide-react v1.33.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Q=[["path",{d:"M11.017 2.814a1 1 0 0 1 1.966 0l1.051 5.558a2 2 0 0 0 1.594 1.594l5.558 1.051a1 1 0 0 1 0 1.966l-5.558 1.051a2 2 0 0 0-1.594 1.594l-1.051 5.558a1 1 0 0 1-1.966 0l-1.051-5.558a2 2 0 0 0-1.594-1.594l-5.558-1.051a1 1 0 0 1 0-1.966l5.558-1.051a2 2 0 0 0 1.594-1.594z",key:"1s2grr"}],["path",{d:"M20 2v4",key:"1rf3ol"}],["path",{d:"M22 4h-4",key:"gwowj6"}],["circle",{cx:"4",cy:"20",r:"2",key:"6kqj1y"}]],Z=$("sparkles",Q);/**
 * @license lucide-react v1.33.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const J=[["path",{d:"m7 11 2-2-2-2",key:"1lz0vl"}],["path",{d:"M11 13h4",key:"1p7l4v"}],["rect",{width:"18",height:"18",x:"3",y:"3",rx:"2",ry:"2",key:"1m3agn"}]],ee=$("square-terminal",J),ne=/^([|>])([+-]?)(\d*)([+-]?)$/,U=/^(\s*)([A-Za-z0-9_.-]+)\s*:\s?(.*)$/,j=/^(\s*)-\s+(.*)$/;function v(e){return e.length-e.trimStart().length}function I(e,n){if(e.length<2||!e.startsWith(n)||!e.endsWith(n))return!1;const t=e.slice(1,-1);if(n==="'"){for(let a=0;a<t.length;a+=1)if(t[a]==="'"){if(t[a+1]==="'"){a+=1;continue}return!1}return!0}for(let a=0;a<t.length;a+=1){if(t[a]==="\\"){a+=1;continue}if(t[a]==='"')return!1}return!0}function F(e){return I(e,'"')?e.slice(1,-1).replace(/\\(["\\])/g,"$1"):I(e,"'")?e.slice(1,-1).replace(/''/g,"'"):e}function W(e){if(e.startsWith('"')||e.startsWith("'"))return e;const n=e.search(/(^|\s)#/);return n===-1?e:e.slice(0,n)}function q(e){const n=W(e.trim()).trim();return F(n)}function te(e){const n=W(e.trim()).trim();if(I(n,'"')||I(n,"'"))return F(n);if(n==="true")return!0;if(n==="false")return!1;if(n!==""){const t=Number(n);if(!Number.isNaN(t))return t}return n}function ae(e){let n="",t=0;for(const a of e){if(a===""){t+=1;continue}n===""?n=a:(n+=t>0?`
`.repeat(t):" ",n+=a),t=0}return n}function se(e,n,t){return t==="strip"?e:t==="keep"?e+`
`.repeat(n+1):e===""?"":`${e}
`}function oe(e,n,t,a,i){const h=[];let r=n;for(;r+1<e.length;){const l=e[r+1];if(l.trim()===""){h.push(""),r+=1;continue}if(v(l)<=t)break;h.push(l),r+=1}let c=h.length-1;for(;c>=0&&h[c]==="";)c-=1;const d=h.length-1-c,u=h.slice(0,c+1),p=u.reduce((l,m)=>m===""?l:Math.min(l,v(m)),Number.MAX_SAFE_INTEGER),f=u.map(l=>l===""?"":l.slice(Math.min(p,v(l)))),b=a==="|"?f.join(`
`):ae(f);return{value:se(b,d,i),endIndex:r}}function ie(e){const n=e[2]||e[4];return n==="-"?"strip":n==="+"?"keep":"clip"}function re(e,n){for(let t=n+1;t<e.length;t+=1){const a=e[t];if(!(a.trim()===""||a.trimStart().startsWith("#")))return a}}function le(e){return e.replace(/^\uFEFF/,"").replace(/\r\n?/g,`
`)}function D(e){const n=le(e);if(!/^---[ \t]*(\n|$)/.test(n))return{data:{},content:n};const t=n.split(`
`);let a=-1;for(let u=1;u<t.length;u+=1){const p=t[u];if(p==="---"||p==="..."||/^(---|\.\.\.)[ \t]+$/.test(p)){a=u;break}}if(a===-1)return{data:{},content:n};const i=t.slice(1,a),h=t.slice(a+1).join(`
`),r={};let c=null,d=null;for(let u=0;u<i.length;u+=1){const p=i[u];if(p.trim()===""||p.trimStart().startsWith("#"))continue;const f=p.match(j);if(f&&c){const g=r[c];Array.isArray(g)&&g.push(q(f[2]));continue}const b=p.match(U);if(!b){c=null,d=null;continue}const[,l,m,R]=b,k=l.length>0;if(k&&!d)continue;k||(d=null,c=null);const O=R.trim(),S=O.match(ne);if(S){const{value:g,endIndex:K}=oe(i,u,l.length,S[1],ie(S));u=K,k&&d?r[d][m]=g:r[m]=g;continue}if(O===""){const g=re(i,u);if(g&&j.test(g)&&v(g)>=l.length){r[m]=[],c=m,d=null;continue}if(g&&v(g)>l.length&&U.test(g)){r[m]={},d=m,c=null;continue}k&&d?r[d][m]="":r[m]="";continue}if(k&&d){r[d][m]=q(R);continue}r[m]=te(R),c=null}return{data:r,content:h}}function B(e){return e.replace(/^\s*#\s+.+?(\n+|$)/,"")}const de=/\$ARGUMENTS\b|\$[1-9]\b/,he=/!`[^`]+`/,ce=/`([a-z0-9]+(?:-[a-z0-9]+)*)`/g;function ue(e,n){const t=e.replace(/!`[^`]+`/g," "),a=[];for(const i of t.matchAll(ce)){const h=i[1];n.has(h)&&!a.includes(h)&&a.push(h)}return a}function G(e){const n=e.split("/").filter(Boolean).pop()??"";return n.endsWith(".md")?n.slice(0,-3):""}function pe(e,n){return n?`/${e} <arguments>`:`/${e}`}function me(e,n,t={}){const a=G(e);if(!a)return null;const{data:i,content:h}=D(n),r=h.trim(),c=(i.description??"").trim();if(r==="")return null;const d=ue(r,t.skillNames??new Set);return{name:a,description:c,agent:i.agent,model:i.model,subtask:i.subtask===!0,body:r,takesArguments:de.test(r),runsShell:he.test(r),relatedSkills:d,...t.simulation?{simulation:t.simulation}:{},bytes:typeof TextEncoder>"u"?n.length:new TextEncoder().encode(n).length}}function ge(e,n={}){return Object.entries(e).map(([t,a])=>{var i;return me(t,a,{skillNames:n.skillNames,simulation:(i=n.simulations)==null?void 0:i.get(G(t))})}).filter(t=>t!==null).sort((t,a)=>t.name.localeCompare(a.name))}function fe(e,n){const t=n.trim().toLowerCase();return t===""?e:e.filter(a=>[a.name,a.description,a.body,a.relatedSkills.join(" ")].join(" ").toLowerCase().includes(t))}const we="leoncheng57",H="custom-dca-opencode",x=`${we}/${H}`,C=`https://github.com/${x}`,w="agent-skills",E="main",be=`${H}-${E}`;function Da(e){const n=`https://raw.githubusercontent.com/${x}/${E}/${w}/commands/${e}.md`;return[{id:"curl-global",label:"curl",scope:"global",note:"Recommended. Available in every project you open with OpenCode.",command:["mkdir -p ~/.config/opencode/commands && \\",`curl -sL ${n} \\`,`  -o ~/.config/opencode/commands/${e}.md`].join(`
...
`)},{id:"symlink",label:"clone + symlink",scope:"global",note:"Stays updatable: git pull in the clone refreshes the live command.",command:[`git clone ${C}.git ~/src/custom-dca-opencode   # once`,"mkdir -p ~/.config/opencode/commands",`ln -s ~/src/custom-dca-opencode/${w}/commands/${e}.md \\`,`      ~/.config/opencode/commands/${e}.md`].join(`
`)}]}const ye=[{path:"~/.config/opencode/commands/<name>.md",scope:"Global",readBy:"OpenCode",note:"Every project. Start here."},{path:".opencode/commands/<name>.md",scope:"Project",readBy:"OpenCode",note:"Committed with the repo; loads only inside it."},{path:".claude/commands/<name>.md",scope:"Project",readBy:"Claude Code",note:"Different frontmatter dialect (argument-hint, allowed-tools). Not shipped here."}];function Pa(e){return[{id:"skills-cli",label:"skills CLI",scope:"global",note:"Recommended. Resolves the repo’s skills/ directory for you; -g installs globally.",command:`npx skills add ${C}/tree/${E}/${w} --skill ${e} -g`},{id:"degit",label:"degit",scope:"global",note:"Copies one directory with no git history attached.",command:`npx degit ${x}/${w}/skills/${e} ~/.agents/skills/${e}`},{id:"curl",label:"curl + tar",scope:"global",note:"No Node required. Extracts a single directory out of the tarball.",command:["mkdir -p ~/.agents/skills && \\",`curl -sL https://codeload.github.com/${x}/tar.gz/refs/heads/${E} \\`,"  | tar -xz -C ~/.agents/skills --strip-components=3 \\",`      ${be}/${w}/skills/${e}`].join(`
`)},{id:"sparse-symlink",label:"sparse clone + symlink",scope:"global",note:"Stays updatable: git pull in ~/src/custom-dca-opencode refreshes the live skill.",command:[`git clone --filter=blob:none --sparse ${C}.git ~/src/custom-dca-opencode`,`cd ~/src/custom-dca-opencode && git sparse-checkout set ${w}/skills/${e}`,`ln -s ~/src/custom-dca-opencode/${w}/skills/${e} ~/.agents/skills/${e}`].join(`
`)},{id:"project-local",label:"project-local",scope:"project",note:"Commits with the repo, so the skill travels with the codebase and loads only there.",command:["# from the root of your project",`npx degit ${x}/${w}/skills/${e} .agents/skills/${e}`].join(`
`)}]}const ke=[{path:"~/.agents/skills/<skill>/",scope:"Global",readBy:"OpenCode, Cursor, Codex, Copilot, Gemini CLI, Amp, Roo, Zed",note:"Highest reach — install here unless you have a reason not to."},{path:"~/.claude/skills/<skill>/",scope:"Global",readBy:"Claude Code",note:"The Claude Code variant of the same layout."},{path:".agents/skills/<skill>/",scope:"Project",readBy:"OpenCode, Cursor, Codex, Copilot, Gemini CLI, Amp, Roo, Zed",note:"Highest reach at project scope — commit it and every collaborator gets the skill."},{path:".opencode/skills/<skill>/",scope:"Project",readBy:"OpenCode",note:"Committed with the repo, so the skill only loads inside that project."},{path:".claude/skills/<skill>/",scope:"Project",readBy:"Claude Code",note:"Project-scoped equivalent for Claude Code."}],ve=220,xe=new Set(["e.g","i.e","etc","vs","cf","approx","al","mr","ms","dr","no"]),Te=240;function P(e){const n=e.split("/").filter(Boolean);return n[n.length-2]??""}function _e(e){return e.split(/[-_]+/).filter(Boolean).map(n=>/[A-Z]/.test(n)?n:n.charAt(0).toUpperCase()+n.slice(1)).join(" ")}function Ie(e,n=Te){const t=e.replace(/\s+/g," ").trim();if(t==="")return"";for(let a=0;a<t.length;a+=1){if(!".!?".includes(t[a]))continue;const i=t[a+1];if(i!==void 0&&i!==" ")continue;const h=t.slice(0,a).split(/[\s(]/).pop();if(t[a]==="."&&h&&xe.has(h.toLowerCase()))continue;const r=t.slice(0,a+1);return r.length<=n?r:L(r,n)}return t.length<=n?t:L(t,n)}function L(e,n){const t=e.slice(0,n),a=t.lastIndexOf(" ");return`${(a>n*.6?t.slice(0,a):t).replace(/[,;:.\s]+$/,"")}…`}function Ee(e){if(!e)return[];const n=new Set;return e.split(",").map(t=>t.trim()).filter(t=>t===""||n.has(t.toLowerCase())?!1:(n.add(t.toLowerCase()),!0))}function Ae(e){const n=e.trim().split(/\s+/).filter(Boolean).length;return Math.max(1,Math.round(n/ve))}function Re(e){return typeof TextEncoder>"u"?e.length:new TextEncoder().encode(e).length}function Se(e,n,t){var p;const a=P(e);if(!a)return null;const{data:i,content:h}=D(n),r=i.metadata??{},c=a,d=(i.description??"").trim(),u=B(h).trim();return{name:c,title:((p=r.title)==null?void 0:p.trim())||_e(c),description:d,summary:Ie(d),tags:Ee(r.tags),license:i.license,compatibility:i.compatibility,metadata:r,body:u,readingTimeMinutes:Ae(u),bytes:Re(n),...t?{simulation:t}:{}}}function Ce(e,n=new Map){return Object.entries(e).map(([t,a])=>Se(t,a,n.get(P(t)))).filter(t=>t!==null).sort((t,a)=>t.name.localeCompare(a.name))}function Ne(e,n){const t=n.trim().toLowerCase();return t===""?e:e.filter(a=>[a.name,a.title,a.description,a.tags.join(" ")].join(" ").toLowerCase().includes(t))}function De(e){return[...new Set(e.flatMap(n=>n.tags))].sort((n,t)=>n.localeCompare(t))}const Pe=`---
name: ascii-diagrams
...
`,Gn=["user","assistant","tool","note"],Hn=/^##[ \t]+([a-z]+)(?:[ \t]+—[ \t]*(.*))?[ \t]*$/,Vn=/^[ \t]{0,3}(`{3,}|~{3,})(.*)$/;function Kn(e){return Gn.includes(e)}function zn(e){const n=[];let t=null,a=null;for(const i of e.split(`
`)){const h=i.match(Vn);if(h){const[,c,d]=h;a===null?a=c:c[0]===a[0]&&c.length>=a.length&&d.trim()===""&&(a=null),t==null||t.lines.push(i);continue}const r=a===null?i.match(Hn):null;if(r){const[,c,d]=r;if(!Kn(c))return null;t={role:c,label:(d==null?void 0:d.trim())||void 0,lines:[]},n.push(t);continue}if(t){t.lines.push(i);continue}if(i.trim()!=="")return null}return n}function Yn(e){const{data:n,content:t}=D(e),a=(n.title??"").trim(),i=(n.trigger??"").trim(),h=(n.caveat??"").trim();if(a===""||i===""||h==="")return null;const r=zn(B(t));if(r===null||r.length===0||r[0].role!=="user")return null;const c=r.map(d=>({...d,body:d.lines.join(`
`).trim()})).filter(d=>d.body!=="").map(({role:d,label:u,body:p})=>u===void 0?{role:d,body:p}:{role:d,label:u,body:p});return c.length===0?null:{title:a,trigger:i,caveat:h,turns:c}}function V(e){const n=new Map;for(const[t,a]of Object.entries(e)){const i=P(t),h=i===""?null:Yn(a);h&&n.set(i,h)}return n}const Xn=Object.assign({"../../agent-skills/skills/ascii-diagrams/SKILL.md":Pe,"../../agent-skills/skills/background-subagent/SKILL.md":Oe,"../../agent-skills/skills/build-waves/SKILL.md":Ue,"../../agent-skills/skills/cite-file-lines/SKILL.md":je,"../../agent-skills/skills/deep-research-subagents/SKILL.md":qe,"../../agent-skills/skills/docs-and-diagram-tooling/SKILL.md":Le,"../../agent-skills/skills/duck-mode/SKILL.md":Me,"../../agent-skills/skills/grill-me/SKILL.md":$e,"../../agent-skills/skills/human-verification-steps/SKILL.md":Fe,"../../agent-skills/skills/manager-children/SKILL.md":We,"../../agent-skills/skills/native-worktree-subagents/SKILL.md":Be,"../../agent-skills/skills/parallel-research-handoff/SKILL.md":Ge,"../../agent-skills/skills/red-team-this/SKILL.md":He,"../../agent-skills/skills/session-handoff/SKILL.md":Ve,"../../agent-skills/skills/worktree-up/SKILL.md":Ke}),Qn=Object.assign({"../../agent-skills/skills/ascii-diagrams/SIMULATION.md":ze,"../../agent-skills/skills/background-subagent/SIMULATION.md":Ye,"../../agent-skills/skills/build-waves/SIMULATION.md":Xe,"../../agent-skills/skills/cite-file-lines/SIMULATION.md":Qe,"../../agent-skills/skills/deep-research-subagents/SIMULATION.md":Ze,"../../agent-skills/skills/docs-and-diagram-tooling/SIMULATION.md":Je,"../../agent-skills/skills/duck-mode/SIMULATION.md":en,"../../agent-skills/skills/grill-me/SIMULATION.md":nn,"../../agent-skills/skills/human-verification-steps/SIMULATION.md":tn,"../../agent-skills/skills/manager-children/SIMULATION.md":an,"../../agent-skills/skills/native-worktree-subagents/SIMULATION.md":sn,"../../agent-skills/skills/parallel-research-handoff/SIMULATION.md":on,"../../agent-skills/skills/red-team-this/SIMULATION.md":rn,"../../agent-skills/skills/session-handoff/SIMULATION.md":ln,"../../agent-skills/skills/worktree-up/SIMULATION.md":dn}),Zn=Object.assign({"../../agent-skills/commands/background.md":hn,"../../agent-skills/commands/build-waves.md":cn,"../../agent-skills/commands/cite-file-lines.md":un,"../../agent-skills/commands/deep-research.md":pn,"../../agent-skills/commands/diagram.md":mn,"../../agent-skills/commands/docs-preview.md":gn,"../../agent-skills/commands/duck-mode.md":fn,"../../agent-skills/commands/grill-me.md":wn,"../../agent-skills/commands/handoff.md":bn,"../../agent-skills/commands/manager-children.md":yn,"../../agent-skills/commands/native-worktree-subagents.md":kn,"../../agent-skills/commands/red-team.md":vn,"../../agent-skills/commands/research-handoff.md":xn,"../../agent-skills/commands/session-handoff.md":Tn,"../../agent-skills/commands/standup.md":_n,"../../agent-skills/commands/verify.md":In,"../../agent-skills/commands/worktree-up.md":En}),Jn=Object.assign({"../../agent-skills/command-simulations/background.md":An,"../../agent-skills/command-simulations/build-waves.md":Rn,"../../agent-skills/command-simulations/cite-file-lines.md":Sn,"../../agent-skills/command-simulations/deep-research.md":Cn,"../../agent-skills/command-simulations/diagram.md":Nn,"../../agent-skills/command-simulations/docs-preview.md":Dn,"../../agent-skills/command-simulations/duck-mode.md":Pn,"../../agent-skills/command-simulations/grill-me.md":On,"../../agent-skills/command-simulations/handoff.md":Un,"../../agent-skills/command-simulations/manager-children.md":jn,"../../agent-skills/command-simulations/native-worktree-subagents.md":qn,"../../agent-skills/command-simulations/red-team.md":Ln,"../../agent-skills/command-simulations/research-handoff.md":Mn,"../../agent-skills/command-simulations/session-handoff.md":$n,"../../agent-skills/command-simulations/standup.md":Fn,"../../agent-skills/command-simulations/verify.md":Wn,"../../agent-skills/command-simulations/worktree-up.md":Bn});function et(e){return Object.fromEntries(Object.entries(e).map(([n,t])=>{var i;return[`commands/${((i=n.split("/").pop())==null?void 0:i.replace(/\.md$/u,""))??""}/SIMULATION.md`,t]}))}const T=Ce(Xn,V(Qn)),A=ge(Zn,{skillNames:new Set(T.map(e=>e.name)),simulations:V(et(Jn))});function Oa(e){return T.find(n=>n.name===e)}function Ua(e){return A.find(n=>n.name===e)}function ja(e){return A.find(n=>n.relatedSkills.length===1&&n.relatedSkills[0]===e)}const nt="https://github.com/leoncheng57/custom-dca-opencode",_=`${nt}/blob/main/agent-skills`,qa={skill:e=>`${_}/skills/${e}/SKILL.md`,skillSimulation:e=>`${_}/skills/${e}/SIMULATION.md`,command:e=>`${_}/commands/${e}.md`,commandSimulation:e=>`${_}/command-simulations/${e}.md`},tt="_page_1hggs_1",at="_content_1hggs_8",st="_wipWarning_1hggs_14",ot="_eyebrow_1hggs_16",it="_type_1hggs_16",rt="_count_1hggs_16",lt="_filterLabel_1hggs_16",dt="_filterInput_1hggs_16",ht="_tag_1hggs_16",ct="_meta_1hggs_16",ut="_source_1hggs_16",pt="_terminal_1hggs_16",mt="_methodScope_1hggs_16",gt="_hero_1hggs_20",ft="_modalTitle_1hggs_37",wt="_cardTitle_1hggs_37",bt="_sectionTitle_1hggs_37",yt="_lede_1hggs_42",kt="_typeStats_1hggs_44",vt="_typeStat_1hggs_44",xt="_catalog_1hggs_49",Tt="_catalogHead_1hggs_50",_t="_filter_1hggs_16",It="_clear_1hggs_57",Et="_tab_1hggs_58",At="_cardLink_1hggs_58",Rt="_tabs_1hggs_60",St="_tags_1hggs_60",Ct="_tabActive_1hggs_64",Nt="_grid_1hggs_68",Dt="_card_1hggs_37",Pt="_cardTop_1hggs_70",Ot="_typeSkill_1hggs_74",Ut="_typeCommand_1hggs_75",jt="_cardSkill_1hggs_76",qt="_cardCommand_1hggs_77",Lt="_cardCopy_1hggs_78",Mt="_cardTags_1hggs_78",$t="_empty_1hggs_79",Ft="_locations_1hggs_81",Wt="_tableWrap_1hggs_81",Bt="_table_1hggs_81",Gt="_dialog_1hggs_83",Ht="_dialogBody_1hggs_84",Vt="_close_1hggs_84",Kt="_modalHead_1hggs_85",zt="_modalDescription_1hggs_85",Yt="_route_1hggs_85",Xt="_detailGrid_1hggs_86",Qt="_side_1hggs_86",Zt="_terminalBar_1hggs_88",Jt="_light_1hggs_88",ea="_terminalPath_1hggs_88",na="_terminalSource_1hggs_88",ta="_terminalTurns_1hggs_88",aa="_turn_1hggs_88",sa="_turnRole_1hggs_88",oa="_turnAssistant_1hggs_88",ia="_turnTool_1hggs_88",ra="_turnNote_1hggs_88",la="_terminalControls_1hggs_88",da="_terminalButton_1hggs_88",ha="_terminalButtonPrimary_1hggs_88",ca="_terminalStatus_1hggs_88",ua="_progress_1hggs_88",pa="_terminalCaveat_1hggs_88",ma="_disclosures_1hggs_90",ga="_disclosure_1hggs_90",fa="_disclosureMeta_1hggs_90",wa="_disclosureBody_1hggs_90",ba="_descriptionPanel_1hggs_90",ya="_descriptionBar_1hggs_90",ka="_descriptionBody_1hggs_90",va="_relation_1hggs_90",xa="_method_1hggs_16",Ta="_methodHead_1hggs_90",_a="_methodCopy_1hggs_90",Ia="_command_1hggs_90",Ea="_notFound_1hggs_90",o={page:tt,content:at,wipWarning:st,eyebrow:ot,type:it,count:rt,filterLabel:lt,filterInput:dt,tag:ht,meta:ct,source:ut,terminal:pt,methodScope:mt,hero:gt,modalTitle:ft,cardTitle:wt,sectionTitle:bt,lede:yt,typeStats:kt,typeStat:vt,catalog:xt,catalogHead:Tt,filter:_t,clear:It,tab:Et,cardLink:At,tabs:Rt,tags:St,tabActive:Ct,grid:Nt,card:Dt,cardTop:Pt,typeSkill:Ot,typeCommand:Ut,cardSkill:jt,cardCommand:qt,cardCopy:Lt,cardTags:Mt,empty:$t,locations:Ft,tableWrap:Wt,table:Bt,dialog:Gt,dialogBody:Ht,close:Vt,modalHead:Kt,modalDescription:zt,route:Yt,detailGrid:Xt,side:Qt,terminalBar:Zt,light:Jt,terminalPath:ea,terminalSource:na,terminalTurns:ta,turn:aa,turnRole:sa,turnAssistant:oa,turnTool:ia,turnNote:ra,terminalControls:la,terminalButton:da,terminalButtonPrimary:ha,terminalStatus:ca,progress:ua,terminalCaveat:pa,disclosures:ma,disclosure:ga,disclosureMeta:fa,disclosureBody:wa,descriptionPanel:ba,descriptionBar:ya,descriptionBody:ka,relation:va,method:xa,methodHead:Ta,methodCopy:_a,command:Ia,notFound:Ea};function Aa({skill:e,onTag:n}){return s.jsxs("article",{className:`${o.card} ${o.cardSkill}`,"data-playbook-kind":"skill","data-testid":"opencode-playbook-skill-card",children:[s.jsxs("div",{className:o.cardTop,children:[s.jsxs("span",{className:`${o.type} ${o.typeSkill}`,children:[s.jsx(Z,{"aria-hidden":"true",size:10})," Skill · model-selected"]}),s.jsxs("span",{className:o.meta,children:[e.readingTimeMinutes," min"]})]}),s.jsx("h2",{className:o.cardTitle,children:e.title}),s.jsx("p",{className:o.cardCopy,children:e.summary}),s.jsx("div",{className:o.cardTags,children:e.tags.map(t=>s.jsxs("button",{className:o.tag,"data-testid":"opencode-playbook-tag",onClick:()=>n(t),type:"button",children:["#",t]},t))}),s.jsx(N,{className:o.cardLink,"data-testid":`opencode-playbook-skill-${e.name}`,to:`/playbooks/skills/${e.name}`,children:"Read playbook →"})]})}function Ra({command:e}){return s.jsxs("article",{className:`${o.card} ${o.cardCommand}`,"data-playbook-kind":"command","data-testid":"opencode-playbook-command-card",children:[s.jsxs("div",{className:o.cardTop,children:[s.jsxs("span",{className:`${o.type} ${o.typeCommand}`,children:[s.jsx(ee,{"aria-hidden":"true",size:10})," Command · human-invoked"]}),s.jsx("span",{className:o.meta,children:e.subtask?"subtask":"session"})]}),s.jsx("h2",{className:o.cardTitle,children:pe(e.name,e.takesArguments)}),s.jsx("p",{className:o.cardCopy,children:e.description}),s.jsxs("div",{className:o.cardTags,children:[e.runsShell&&s.jsx("span",{children:"shell input"}),e.relatedSkills.map(n=>s.jsx("span",{children:n},n))]}),s.jsx(N,{className:o.cardLink,"data-testid":`opencode-playbook-command-${e.name}`,to:`/playbooks/commands/${e.name}`,children:"Read command →"})]})}const Sa=[{kind:"all",label:"All",href:"/playbooks"},{kind:"skills",label:"Skills",href:"/playbooks/skills"},{kind:"commands",label:"Commands",href:"/playbooks/commands"}];function M({kind:e}){const n=e==="skills"?ke:ye;return s.jsxs("section",{className:o.locations,"aria-labelledby":`${e}-locations-heading`,children:[s.jsx("div",{className:o.eyebrow,children:"Install locations"}),s.jsxs("h2",{className:o.sectionTitle,id:`${e}-locations-heading`,children:["Where ",e," live"]}),s.jsx("p",{children:e==="skills"?"Skills are portable directories read by several agent families. Global paths apply everywhere; project paths travel with one repository.":"Commands are individual OpenCode markdown files. They cost no context until a human invokes them."}),s.jsx("div",{className:o.tableWrap,children:s.jsxs("table",{className:o.table,children:[s.jsx("thead",{children:s.jsxs("tr",{children:[s.jsx("th",{scope:"col",children:"Path"}),s.jsx("th",{scope:"col",children:"Scope"}),s.jsx("th",{scope:"col",children:"Read by"})]})}),s.jsx("tbody",{children:n.map(t=>s.jsxs("tr",{children:[s.jsx("th",{scope:"row",children:t.path}),s.jsx("td",{children:t.scope}),s.jsxs("td",{children:[t.readBy,s.jsx("span",{children:t.note})]})]},t.path))})]})})]})}function Ca({kind:e="all",detail:n}){var b;const[t,a]=y.useState(""),i=y.useRef(null),h=y.useRef(null),r=((b=z().state)==null?void 0:b.focusCatalog)===!0;y.useEffect(()=>{var l;r&&((l=h.current)==null||l.focus())},[r]);const c=y.useMemo(()=>e==="commands"?[]:Ne(T,t),[e,t]),d=y.useMemo(()=>e==="skills"?[]:fe(A,t),[e,t]),u=y.useMemo(()=>De(T),[]),p=c.length+d.length,f=l=>{var m;a(l),(m=i.current)==null||m.focus()};return s.jsxs("main",{className:o.page,"data-testid":"opencode-playbooks",ref:h,tabIndex:-1,children:[s.jsxs("div",{className:o.content,children:[s.jsx(Y,{className:o.wipWarning,"data-testid":"opencode-playbooks-wip-warning",variant:"warning",children:"Playbooks is still work in progress and its UI/UX may contain bugs."}),s.jsxs("header",{className:o.hero,children:[s.jsxs("div",{children:[s.jsx("div",{className:o.eyebrow,children:"Repository-owned agent procedures"}),s.jsx("h1",{children:"Repeatable ways to work with an agent."}),s.jsx("p",{className:o.lede,children:"Skills are selected by the model. Commands are invoked by a human. Guided workflows can join them here later without turning one content type into the whole product."})]}),s.jsxs("aside",{className:o.typeStats,"aria-label":"Playbook types",children:[s.jsxs("div",{className:o.typeStat,children:[s.jsx("strong",{children:T.length}),s.jsx("span",{children:"Skills"})]}),s.jsxs("div",{className:o.typeStat,children:[s.jsx("strong",{children:A.length}),s.jsx("span",{children:"Commands"})]}),s.jsxs("div",{className:o.typeStat,children:[s.jsx("strong",{children:"Next"}),s.jsx("span",{children:"Workflows"})]})]})]}),s.jsxs("section",{className:o.catalog,"aria-labelledby":"playbook-catalog-heading",children:[s.jsxs("div",{className:o.catalogHead,children:[s.jsxs("div",{children:[s.jsx("div",{className:o.eyebrow,children:"Catalogue"}),s.jsxs("h2",{className:o.sectionTitle,id:"playbook-catalog-heading",children:[p," matching playbooks ",s.jsx("span",{className:o.count,children:e})]})]}),s.jsxs("label",{className:o.filter,children:[s.jsx(X,{"aria-hidden":"true",size:14}),s.jsx("span",{className:o.filterLabel,children:"filter"}),s.jsx("input",{className:o.filterInput,"data-testid":"opencode-playbook-filter",onChange:l=>a(l.target.value),placeholder:"name, tag, or trigger phrase",ref:i,type:"search",value:t}),t&&s.jsx("button",{"aria-label":"Clear filter",className:o.clear,"data-testid":"opencode-playbook-filter-clear",onClick:()=>{var l;a(""),(l=i.current)==null||l.focus()},type:"button",children:"×"})]})]}),s.jsx("nav",{className:o.tabs,"aria-label":"Playbook types",children:Sa.map(l=>s.jsx(N,{className:`${o.tab} ${l.kind===e?o.tabActive:""}`,"data-testid":`opencode-playbook-kind-${l.kind}`,to:l.href,children:l.label},l.kind))}),e!=="commands"&&s.jsxs("div",{className:o.tags,children:[s.jsx("span",{children:"try:"}),u.map(l=>s.jsxs("button",{className:o.tag,"data-testid":"opencode-playbook-hero-tag",onClick:()=>f(l),type:"button",children:["#",l]},l))]}),p?s.jsxs("div",{className:o.grid,children:[c.map(l=>s.jsx(Aa,{onTag:f,skill:l},l.name)),d.map(l=>s.jsx(Ra,{command:l},l.name))]}):s.jsxs("p",{className:o.empty,children:["No playbook matches ",s.jsx("code",{children:t.trim()}),"."]})]}),e==="skills"&&s.jsx(M,{kind:"skills"}),e==="commands"&&s.jsx(M,{kind:"commands"})]}),n]})}const La=Object.freeze(Object.defineProperty({__proto__:null,PlaybooksPage:Ca},Symbol.toStringTag,{value:"Module"}));export{Ca as P,Oa as a,ja as b,Da as c,Pa as d,La as e,Ua as f,pe as i,qa as p,o as s};
