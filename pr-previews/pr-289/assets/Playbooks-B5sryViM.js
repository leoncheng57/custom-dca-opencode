import{r as y,j as s,A as K,S as z,L as N}from"./index-bdQIb_I4.js";const Y=/^([|>])([+-]?)(\d*)([+-]?)$/,U=/^(\s*)([A-Za-z0-9_.-]+)\s*:\s?(.*)$/,j=/^(\s*)-\s+(.*)$/;function k(e){return e.length-e.trimStart().length}function I(e,n){if(e.length<2||!e.startsWith(n)||!e.endsWith(n))return!1;const t=e.slice(1,-1);if(n==="'"){for(let a=0;a<t.length;a+=1)if(t[a]==="'"){if(t[a+1]==="'"){a+=1;continue}return!1}return!0}for(let a=0;a<t.length;a+=1){if(t[a]==="\\"){a+=1;continue}if(t[a]==='"')return!1}return!0}function F(e){return I(e,'"')?e.slice(1,-1).replace(/\\(["\\])/g,"$1"):I(e,"'")?e.slice(1,-1).replace(/''/g,"'"):e}function W(e){if(e.startsWith('"')||e.startsWith("'"))return e;const n=e.search(/(^|\s)#/);return n===-1?e:e.slice(0,n)}function q(e){const n=W(e.trim()).trim();return F(n)}function X(e){const n=W(e.trim()).trim();if(I(n,'"')||I(n,"'"))return F(n);if(n==="true")return!0;if(n==="false")return!1;if(n!==""){const t=Number(n);if(!Number.isNaN(t))return t}return n}function Q(e){let n="",t=0;for(const a of e){if(a===""){t+=1;continue}n===""?n=a:(n+=t>0?`
`.repeat(t):" ",n+=a),t=0}return n}function Z(e,n,t){return t==="strip"?e:t==="keep"?e+`
`.repeat(n+1):e===""?"":`${e}
`}function J(e,n,t,a,i){const h=[];let r=n;for(;r+1<e.length;){const p=e[r+1];if(p.trim()===""){h.push(""),r+=1;continue}if(k(p)<=t)break;h.push(p),r+=1}let c=h.length-1;for(;c>=0&&h[c]==="";)c-=1;const d=h.length-1-c,u=h.slice(0,c+1),l=u.reduce((p,m)=>m===""?p:Math.min(p,k(m)),Number.MAX_SAFE_INTEGER),f=u.map(p=>p===""?"":p.slice(Math.min(l,k(p)))),T=a==="|"?f.join(`
`):Q(f);return{value:Z(T,d,i),endIndex:r}}function ee(e){const n=e[2]||e[4];return n==="-"?"strip":n==="+"?"keep":"clip"}function ne(e,n){for(let t=n+1;t<e.length;t+=1){const a=e[t];if(!(a.trim()===""||a.trimStart().startsWith("#")))return a}}function te(e){return e.replace(/^\uFEFF/,"").replace(/\r\n?/g,`
`)}function D(e){const n=te(e);if(!/^---[ \t]*(\n|$)/.test(n))return{data:{},content:n};const t=n.split(`
`);let a=-1;for(let u=1;u<t.length;u+=1){const l=t[u];if(l==="---"||l==="..."||/^(---|\.\.\.)[ \t]+$/.test(l)){a=u;break}}if(a===-1)return{data:{},content:n};const i=t.slice(1,a),h=t.slice(a+1).join(`
`),r={};let c=null,d=null;for(let u=0;u<i.length;u+=1){const l=i[u];if(l.trim()===""||l.trimStart().startsWith("#"))continue;const f=l.match(j);if(f&&c){const g=r[c];Array.isArray(g)&&g.push(q(f[2]));continue}const T=l.match(U);if(!T){c=null,d=null;continue}const[,p,m,R]=T,b=p.length>0;if(b&&!d)continue;b||(d=null,c=null);const O=R.trim(),S=O.match(Y);if(S){const{value:g,endIndex:V}=J(i,u,p.length,S[1],ee(S));u=V,b&&d?r[d][m]=g:r[m]=g;continue}if(O===""){const g=ne(i,u);if(g&&j.test(g)&&k(g)>=p.length){r[m]=[],c=m,d=null;continue}if(g&&k(g)>p.length&&U.test(g)){r[m]={},d=m,c=null;continue}b&&d?r[d][m]="":r[m]="";continue}if(b&&d){r[d][m]=q(R);continue}r[m]=X(R),c=null}return{data:r,content:h}}function $(e){return e.replace(/^\s*#\s+.+?(\n+|$)/,"")}const ae=/\$ARGUMENTS\b|\$[1-9]\b/,se=/!`[^`]+`/,oe=/`([a-z0-9]+(?:-[a-z0-9]+)*)`/g;function ie(e,n){const t=e.replace(/!`[^`]+`/g," "),a=[];for(const i of t.matchAll(oe)){const h=i[1];n.has(h)&&!a.includes(h)&&a.push(h)}return a}function B(e){const n=e.split("/").filter(Boolean).pop()??"";return n.endsWith(".md")?n.slice(0,-3):""}function re(e,n){return n?`/${e} <arguments>`:`/${e}`}function le(e,n,t={}){const a=B(e);if(!a)return null;const{data:i,content:h}=D(n),r=h.trim(),c=(i.description??"").trim();if(r==="")return null;const d=ie(r,t.skillNames??new Set);return{name:a,description:c,agent:i.agent,model:i.model,subtask:i.subtask===!0,body:r,takesArguments:ae.test(r),runsShell:se.test(r),relatedSkills:d,...t.simulation?{simulation:t.simulation}:{},bytes:typeof TextEncoder>"u"?n.length:new TextEncoder().encode(n).length}}function de(e,n={}){return Object.entries(e).map(([t,a])=>{var i;return le(t,a,{skillNames:n.skillNames,simulation:(i=n.simulations)==null?void 0:i.get(B(t))})}).filter(t=>t!==null).sort((t,a)=>t.name.localeCompare(a.name))}function he(e,n){const t=n.trim().toLowerCase();return t===""?e:e.filter(a=>[a.name,a.description,a.body,a.relatedSkills.join(" ")].join(" ").toLowerCase().includes(t))}const ce="leoncheng57",G="custom-dca-opencode",v=`${ce}/${G}`,C=`https://github.com/${v}`,w="agent-skills",E="main",ue=`${G}-${E}`;function xa(e){const n=`https://raw.githubusercontent.com/${v}/${E}/${w}/commands/${e}.md`;return[{id:"curl-global",label:"curl",scope:"global",note:"Recommended. Available in every project you open with OpenCode.",command:["mkdir -p ~/.config/opencode/commands && \\",`curl -sL ${n} \\`,`  -o ~/.config/opencode/commands/${e}.md`].join(`
...
`)}]}const pe=[{path:"~/.config/opencode/commands/<name>.md",scope:"Global",readBy:"OpenCode",note:"Every project. Start here."},{path:".opencode/commands/<name>.md",scope:"Project",readBy:"OpenCode",note:"Committed with the repo; loads only inside it."},{path:".claude/commands/<name>.md",scope:"Project",readBy:"Claude Code",note:"Different frontmatter dialect (argument-hint, allowed-tools). Not shipped here."}];function Ta(e){return[{id:"skills-cli",label:"skills CLI",scope:"global",note:"Recommended. Resolves the repo’s skills/ directory for you; -g installs globally.",command:`npx skills add ${C}/tree/${E}/${w} --skill ${e} -g`},{id:"degit",label:"degit",scope:"global",note:"Copies one directory with no git history attached.",command:`npx degit ${v}/${w}/skills/${e} ~/.agents/skills/${e}`},{id:"curl",label:"curl + tar",scope:"global",note:"No Node required. Extracts a single directory out of the tarball.",command:["mkdir -p ~/.agents/skills && \\",`curl -sL https://codeload.github.com/${v}/tar.gz/refs/heads/${E} \\`,"  | tar -xz -C ~/.agents/skills --strip-components=3 \\",`      ${ue}/${w}/skills/${e}`].join(`
...
`)},{id:"project-local",label:"project-local",scope:"project",note:"Commits with the repo, so the skill travels with the codebase and loads only there.",command:["# from the root of your project",`npx degit ${v}/${w}/skills/${e} .agents/skills/${e}`].join(`
`)}]}const me=[{path:"~/.agents/skills/<skill>/",scope:"Global",readBy:"OpenCode, Cursor, Codex, Copilot, Gemini CLI, Amp, Roo, Zed",note:"Highest reach — install here unless you have a reason not to."},{path:"~/.claude/skills/<skill>/",scope:"Global",readBy:"Claude Code",note:"The Claude Code variant of the same layout."},{path:".agents/skills/<skill>/",scope:"Project",readBy:"OpenCode, Cursor, Codex, Copilot, Gemini CLI, Amp, Roo, Zed",note:"Highest reach at project scope — commit it and every collaborator gets the skill."},{path:".opencode/skills/<skill>/",scope:"Project",readBy:"OpenCode",note:"Committed with the repo, so the skill only loads inside that project."},{path:".claude/skills/<skill>/",scope:"Project",readBy:"Claude Code",note:"Project-scoped equivalent for Claude Code."}],ge=220,fe=new Set(["e.g","i.e","etc","vs","cf","approx","al","mr","ms","dr","no"]),we=240;function P(e){const n=e.split("/").filter(Boolean);return n[n.length-2]??""}function be(e){return e.split(/[-_]+/).filter(Boolean).map(n=>/[A-Z]/.test(n)?n:n.charAt(0).toUpperCase()+n.slice(1)).join(" ")}function ye(e,n=we){const t=e.replace(/\s+/g," ").trim();if(t==="")return"";for(let a=0;a<t.length;a+=1){if(!".!?".includes(t[a]))continue;const i=t[a+1];if(i!==void 0&&i!==" ")continue;const h=t.slice(0,a).split(/[\s(]/).pop();if(t[a]==="."&&h&&fe.has(h.toLowerCase()))continue;const r=t.slice(0,a+1);return r.length<=n?r:L(r,n)}return t.length<=n?t:L(t,n)}function L(e,n){const t=e.slice(0,n),a=t.lastIndexOf(" ");return`${(a>n*.6?t.slice(0,a):t).replace(/[,;:.\s]+$/,"")}…`}function ke(e){if(!e)return[];const n=new Set;return e.split(",").map(t=>t.trim()).filter(t=>t===""||n.has(t.toLowerCase())?!1:(n.add(t.toLowerCase()),!0))}function ve(e){const n=e.trim().split(/\s+/).filter(Boolean).length;return Math.max(1,Math.round(n/ge))}function xe(e){return typeof TextEncoder>"u"?e.length:new TextEncoder().encode(e).length}function Te(e,n,t){var l;const a=P(e);if(!a)return null;const{data:i,content:h}=D(n),r=i.metadata??{},c=a,d=(i.description??"").trim(),u=$(h).trim();return{name:c,title:((l=r.title)==null?void 0:l.trim())||be(c),description:d,summary:ye(d),tags:ke(r.tags),license:i.license,compatibility:i.compatibility,metadata:r,body:u,readingTimeMinutes:ve(u),bytes:xe(n),...t?{simulation:t}:{}}}function _e(e,n=new Map){return Object.entries(e).map(([t,a])=>Te(t,a,n.get(P(t)))).filter(t=>t!==null).sort((t,a)=>t.name.localeCompare(a.name))}function Ie(e,n){const t=n.trim().toLowerCase();return t===""?e:e.filter(a=>[a.name,a.title,a.description,a.tags.join(" ")].join(" ").toLowerCase().includes(t))}function Ee(e){return[...new Set(e.flatMap(n=>n.tags))].sort((n,t)=>n.localeCompare(t))}const Ae=`---
name: ascii-diagrams
...
`,Ln=["user","assistant","tool","note"],Mn=/^##[ \t]+([a-z]+)(?:[ \t]+—[ \t]*(.*))?[ \t]*$/,Fn=/^[ \t]{0,3}(`{3,}|~{3,})(.*)$/;function Wn(e){return Ln.includes(e)}function $n(e){const n=[];let t=null,a=null;for(const i of e.split(`
`)){const h=i.match(Fn);if(h){const[,c,d]=h;a===null?a=c:c[0]===a[0]&&c.length>=a.length&&d.trim()===""&&(a=null),t==null||t.lines.push(i);continue}const r=a===null?i.match(Mn):null;if(r){const[,c,d]=r;if(!Wn(c))return null;t={role:c,label:(d==null?void 0:d.trim())||void 0,lines:[]},n.push(t);continue}if(t){t.lines.push(i);continue}if(i.trim()!=="")return null}return n}function Bn(e){const{data:n,content:t}=D(e),a=(n.title??"").trim(),i=(n.trigger??"").trim(),h=(n.caveat??"").trim();if(a===""||i===""||h==="")return null;const r=$n($(t));if(r===null||r.length===0||r[0].role!=="user")return null;const c=r.map(d=>({...d,body:d.lines.join(`
`).trim()})).filter(d=>d.body!=="").map(({role:d,label:u,body:l})=>u===void 0?{role:d,body:l}:{role:d,label:u,body:l});return c.length===0?null:{title:a,trigger:i,caveat:h,turns:c}}function H(e){const n=new Map;for(const[t,a]of Object.entries(e)){const i=P(t),h=i===""?null:Bn(a);h&&n.set(i,h)}return n}const Gn=Object.assign({"../../agent-skills/skills/ascii-diagrams/SKILL.md":Ae,"../../agent-skills/skills/background-subagent/SKILL.md":Re,"../../agent-skills/skills/build-waves/SKILL.md":Se,"../../agent-skills/skills/cite-file-lines/SKILL.md":Ce,"../../agent-skills/skills/deep-research-subagents/SKILL.md":Ne,"../../agent-skills/skills/docs-and-diagram-tooling/SKILL.md":De,"../../agent-skills/skills/duck-mode/SKILL.md":Pe,"../../agent-skills/skills/grill-me/SKILL.md":Oe,"../../agent-skills/skills/human-verification-steps/SKILL.md":Ue,"../../agent-skills/skills/manager-children/SKILL.md":je,"../../agent-skills/skills/native-worktree-subagents/SKILL.md":qe,"../../agent-skills/skills/parallel-research-handoff/SKILL.md":Le,"../../agent-skills/skills/red-team-this/SKILL.md":Me,"../../agent-skills/skills/session-handoff/SKILL.md":Fe,"../../agent-skills/skills/worktree-up/SKILL.md":We}),Hn=Object.assign({"../../agent-skills/skills/ascii-diagrams/SIMULATION.md":$e,"../../agent-skills/skills/background-subagent/SIMULATION.md":Be,"../../agent-skills/skills/build-waves/SIMULATION.md":Ge,"../../agent-skills/skills/cite-file-lines/SIMULATION.md":He,"../../agent-skills/skills/deep-research-subagents/SIMULATION.md":Ve,"../../agent-skills/skills/docs-and-diagram-tooling/SIMULATION.md":Ke,"../../agent-skills/skills/duck-mode/SIMULATION.md":ze,"../../agent-skills/skills/grill-me/SIMULATION.md":Ye,"../../agent-skills/skills/human-verification-steps/SIMULATION.md":Xe,"../../agent-skills/skills/manager-children/SIMULATION.md":Qe,"../../agent-skills/skills/native-worktree-subagents/SIMULATION.md":Ze,"../../agent-skills/skills/parallel-research-handoff/SIMULATION.md":Je,"../../agent-skills/skills/red-team-this/SIMULATION.md":en,"../../agent-skills/skills/session-handoff/SIMULATION.md":nn,"../../agent-skills/skills/worktree-up/SIMULATION.md":tn}),Vn=Object.assign({"../../agent-skills/commands/background.md":an,"../../agent-skills/commands/build-waves.md":sn,"../../agent-skills/commands/cite-file-lines.md":on,"../../agent-skills/commands/deep-research.md":rn,"../../agent-skills/commands/diagram.md":ln,"../../agent-skills/commands/docs-preview.md":dn,"../../agent-skills/commands/duck-mode.md":hn,"../../agent-skills/commands/grill-me.md":cn,"../../agent-skills/commands/handoff.md":un,"../../agent-skills/commands/manager-children.md":pn,"../../agent-skills/commands/native-worktree-subagents.md":mn,"../../agent-skills/commands/red-team.md":gn,"../../agent-skills/commands/research-handoff.md":fn,"../../agent-skills/commands/session-handoff.md":wn,"../../agent-skills/commands/standup.md":bn,"../../agent-skills/commands/verify.md":yn,"../../agent-skills/commands/worktree-up.md":kn}),Kn=Object.assign({"../../agent-skills/command-simulations/background.md":vn,"../../agent-skills/command-simulations/build-waves.md":xn,"../../agent-skills/command-simulations/cite-file-lines.md":Tn,"../../agent-skills/command-simulations/deep-research.md":_n,"../../agent-skills/command-simulations/diagram.md":In,"../../agent-skills/command-simulations/docs-preview.md":En,"../../agent-skills/command-simulations/duck-mode.md":An,"../../agent-skills/command-simulations/grill-me.md":Rn,"../../agent-skills/command-simulations/handoff.md":Sn,"../../agent-skills/command-simulations/manager-children.md":Cn,"../../agent-skills/command-simulations/native-worktree-subagents.md":Nn,"../../agent-skills/command-simulations/red-team.md":Dn,"../../agent-skills/command-simulations/research-handoff.md":Pn,"../../agent-skills/command-simulations/session-handoff.md":On,"../../agent-skills/command-simulations/standup.md":Un,"../../agent-skills/command-simulations/verify.md":jn,"../../agent-skills/command-simulations/worktree-up.md":qn});function zn(e){return Object.fromEntries(Object.entries(e).map(([n,t])=>{var i;return[`commands/${((i=n.split("/").pop())==null?void 0:i.replace(/\.md$/u,""))??""}/SIMULATION.md`,t]}))}const x=_e(Gn,H(Hn)),A=de(Vn,{skillNames:new Set(x.map(e=>e.name)),simulations:H(zn(Kn))});function _a(e){return x.find(n=>n.name===e)}function Ia(e){return A.find(n=>n.name===e)}function Ea(e){return A.find(n=>n.relatedSkills.length===1&&n.relatedSkills[0]===e)}const Yn="https://github.com/leoncheng57/custom-dca-opencode",_=`${Yn}/blob/main/agent-skills`,Aa={skill:e=>`${_}/skills/${e}/SKILL.md`,skillSimulation:e=>`${_}/skills/${e}/SIMULATION.md`,command:e=>`${_}/commands/${e}.md`,commandSimulation:e=>`${_}/command-simulations/${e}.md`},Xn="_page_1680g_1",Qn="_content_1680g_8",Zn="_wipWarning_1680g_14",Jn="_eyebrow_1680g_16",et="_type_1680g_16",nt="_count_1680g_16",tt="_filterLabel_1680g_16",at="_filterInput_1680g_16",st="_tag_1680g_16",ot="_meta_1680g_16",it="_source_1680g_16",rt="_terminal_1680g_16",lt="_methodScope_1680g_16",dt="_hero_1680g_20",ht="_modalTitle_1680g_37",ct="_cardTitle_1680g_37",ut="_sectionTitle_1680g_37",pt="_lede_1680g_42",mt="_typeStats_1680g_44",gt="_typeStat_1680g_44",ft="_catalog_1680g_49",wt="_catalogHead_1680g_50",bt="_filter_1680g_16",yt="_clear_1680g_57",kt="_tab_1680g_58",vt="_cardLink_1680g_58",xt="_tabs_1680g_60",Tt="_tags_1680g_60",_t="_tabActive_1680g_64",It="_grid_1680g_68",Et="_card_1680g_37",At="_cardTop_1680g_70",Rt="_cardCopy_1680g_71",St="_cardTags_1680g_71",Ct="_empty_1680g_72",Nt="_locations_1680g_74",Dt="_tableWrap_1680g_74",Pt="_table_1680g_74",Ot="_dialog_1680g_76",Ut="_dialogBody_1680g_77",jt="_close_1680g_77",qt="_modalHead_1680g_78",Lt="_modalDescription_1680g_78",Mt="_route_1680g_78",Ft="_detailGrid_1680g_79",Wt="_side_1680g_79",$t="_note_1680g_79",Bt="_terminalBar_1680g_81",Gt="_light_1680g_81",Ht="_terminalPath_1680g_81",Vt="_terminalSource_1680g_81",Kt="_terminalTurns_1680g_81",zt="_turn_1680g_81",Yt="_turnRole_1680g_81",Xt="_turnAssistant_1680g_81",Qt="_turnTool_1680g_81",Zt="_turnNote_1680g_81",Jt="_terminalControls_1680g_81",ea="_terminalButton_1680g_81",na="_terminalButtonPrimary_1680g_81",ta="_terminalStatus_1680g_81",aa="_progress_1680g_81",sa="_disclosures_1680g_83",oa="_disclosure_1680g_83",ia="_disclosureMeta_1680g_83",ra="_disclosureBody_1680g_83",la="_descriptionPanel_1680g_83",da="_descriptionBar_1680g_83",ha="_descriptionBody_1680g_83",ca="_relation_1680g_83",ua="_method_1680g_16",pa="_methodHead_1680g_83",ma="_methodCopy_1680g_83",ga="_command_1680g_83",fa="_notFound_1680g_83",o={page:Xn,content:Qn,wipWarning:Zn,eyebrow:Jn,type:et,count:nt,filterLabel:tt,filterInput:at,tag:st,meta:ot,source:it,terminal:rt,methodScope:lt,hero:dt,modalTitle:ht,cardTitle:ct,sectionTitle:ut,lede:pt,typeStats:mt,typeStat:gt,catalog:ft,catalogHead:wt,filter:bt,clear:yt,tab:kt,cardLink:vt,tabs:xt,tags:Tt,tabActive:_t,grid:It,card:Et,cardTop:At,cardCopy:Rt,cardTags:St,empty:Ct,locations:Nt,tableWrap:Dt,table:Pt,dialog:Ot,dialogBody:Ut,close:jt,modalHead:qt,modalDescription:Lt,route:Mt,detailGrid:Ft,side:Wt,note:$t,terminalBar:Bt,light:Gt,terminalPath:Ht,terminalSource:Vt,terminalTurns:Kt,turn:zt,turnRole:Yt,turnAssistant:Xt,turnTool:Qt,turnNote:Zt,terminalControls:Jt,terminalButton:ea,terminalButtonPrimary:na,terminalStatus:ta,progress:aa,disclosures:sa,disclosure:oa,disclosureMeta:ia,disclosureBody:ra,descriptionPanel:la,descriptionBar:da,descriptionBody:ha,relation:ca,method:ua,methodHead:pa,methodCopy:ma,command:ga,notFound:fa};function wa({skill:e,onTag:n}){return s.jsxs("article",{className:o.card,"data-testid":"opencode-playbook-skill-card",children:[s.jsxs("div",{className:o.cardTop,children:[s.jsx("span",{className:o.type,children:"Skill"}),s.jsxs("span",{className:o.meta,children:[e.readingTimeMinutes," min"]})]}),s.jsx("h2",{className:o.cardTitle,children:e.title}),s.jsx("p",{className:o.cardCopy,children:e.summary}),s.jsx("div",{className:o.cardTags,children:e.tags.map(t=>s.jsxs("button",{className:o.tag,"data-testid":"opencode-playbook-tag",onClick:()=>n(t),type:"button",children:["#",t]},t))}),s.jsx(N,{className:o.cardLink,"data-testid":`opencode-playbook-skill-${e.name}`,to:`/playbooks/skills/${e.name}`,children:"Read playbook →"})]})}function ba({command:e}){return s.jsxs("article",{className:o.card,"data-testid":"opencode-playbook-command-card",children:[s.jsxs("div",{className:o.cardTop,children:[s.jsx("span",{className:o.type,children:"Command"}),s.jsx("span",{className:o.meta,children:e.subtask?"subtask":"session"})]}),s.jsx("h2",{className:o.cardTitle,children:re(e.name,e.takesArguments)}),s.jsx("p",{className:o.cardCopy,children:e.description}),s.jsxs("div",{className:o.cardTags,children:[e.runsShell&&s.jsx("span",{children:"shell input"}),e.relatedSkills.map(n=>s.jsx("span",{children:n},n))]}),s.jsx(N,{className:o.cardLink,"data-testid":`opencode-playbook-command-${e.name}`,to:`/playbooks/commands/${e.name}`,children:"Read command →"})]})}const ya=[{kind:"all",label:"All",href:"/playbooks"},{kind:"skills",label:"Skills",href:"/playbooks/skills"},{kind:"commands",label:"Commands",href:"/playbooks/commands"}];function M({kind:e}){const n=e==="skills"?me:pe;return s.jsxs("section",{className:o.locations,"aria-labelledby":`${e}-locations-heading`,children:[s.jsx("div",{className:o.eyebrow,children:"Install locations"}),s.jsxs("h2",{className:o.sectionTitle,id:`${e}-locations-heading`,children:["Where ",e," live"]}),s.jsx("p",{children:e==="skills"?"Skills are portable directories read by several agent families. Global paths apply everywhere; project paths travel with one repository.":"Commands are individual OpenCode markdown files. They cost no context until a human invokes them."}),s.jsx("div",{className:o.tableWrap,children:s.jsxs("table",{className:o.table,children:[s.jsx("thead",{children:s.jsxs("tr",{children:[s.jsx("th",{scope:"col",children:"Path"}),s.jsx("th",{scope:"col",children:"Scope"}),s.jsx("th",{scope:"col",children:"Read by"})]})}),s.jsx("tbody",{children:n.map(t=>s.jsxs("tr",{children:[s.jsx("th",{scope:"row",children:t.path}),s.jsx("td",{children:t.scope}),s.jsxs("td",{children:[t.readBy,s.jsx("span",{children:t.note})]})]},t.path))})]})})]})}function ka({kind:e="all",detail:n}){const[t,a]=y.useState(""),i=y.useRef(null),h=y.useMemo(()=>e==="commands"?[]:Ie(x,t),[e,t]),r=y.useMemo(()=>e==="skills"?[]:he(A,t),[e,t]),c=y.useMemo(()=>Ee(x),[]),d=h.length+r.length,u=l=>{var f;a(l),(f=i.current)==null||f.focus()};return s.jsxs("main",{className:o.page,"data-testid":"opencode-playbooks",children:[s.jsxs("div",{className:o.content,children:[s.jsx(K,{className:o.wipWarning,"data-testid":"opencode-playbooks-wip-warning",variant:"warning",children:"Playbooks is still work in progress and its UI/UX may contain bugs."}),s.jsxs("header",{className:o.hero,children:[s.jsxs("div",{children:[s.jsx("div",{className:o.eyebrow,children:"Repository-owned agent procedures"}),s.jsx("h1",{children:"Repeatable ways to work with an agent."}),s.jsx("p",{className:o.lede,children:"Skills are selected by the model. Commands are invoked by a human. Guided workflows can join them here later without turning one content type into the whole product."})]}),s.jsxs("aside",{className:o.typeStats,"aria-label":"Playbook types",children:[s.jsxs("div",{className:o.typeStat,children:[s.jsx("strong",{children:x.length}),s.jsx("span",{children:"Skills"})]}),s.jsxs("div",{className:o.typeStat,children:[s.jsx("strong",{children:A.length}),s.jsx("span",{children:"Commands"})]}),s.jsxs("div",{className:o.typeStat,children:[s.jsx("strong",{children:"Next"}),s.jsx("span",{children:"Workflows"})]})]})]}),s.jsxs("section",{className:o.catalog,"aria-labelledby":"playbook-catalog-heading",children:[s.jsxs("div",{className:o.catalogHead,children:[s.jsxs("div",{children:[s.jsx("div",{className:o.eyebrow,children:"Catalogue"}),s.jsxs("h2",{className:o.sectionTitle,id:"playbook-catalog-heading",children:[d," matching playbooks ",s.jsx("span",{className:o.count,children:e})]})]}),s.jsxs("label",{className:o.filter,children:[s.jsx(z,{"aria-hidden":"true",size:14}),s.jsx("span",{className:o.filterLabel,children:"filter"}),s.jsx("input",{className:o.filterInput,"data-testid":"opencode-playbook-filter",onChange:l=>a(l.target.value),placeholder:"name, tag, or trigger phrase",ref:i,type:"search",value:t}),t&&s.jsx("button",{"aria-label":"Clear filter",className:o.clear,onClick:()=>{var l;a(""),(l=i.current)==null||l.focus()},type:"button",children:"×"})]})]}),s.jsx("nav",{className:o.tabs,"aria-label":"Playbook types",children:ya.map(l=>s.jsx(N,{className:`${o.tab} ${l.kind===e?o.tabActive:""}`,to:l.href,children:l.label},l.kind))}),e!=="commands"&&s.jsxs("div",{className:o.tags,children:[s.jsx("span",{children:"try:"}),c.map(l=>s.jsxs("button",{className:o.tag,onClick:()=>u(l),type:"button",children:["#",l]},l))]}),d?s.jsxs("div",{className:o.grid,children:[h.map(l=>s.jsx(wa,{onTag:u,skill:l},l.name)),r.map(l=>s.jsx(ba,{command:l},l.name))]}):s.jsxs("p",{className:o.empty,children:["No playbook matches ",s.jsx("code",{children:t.trim()}),"."]})]}),e==="skills"&&s.jsx(M,{kind:"skills"}),e==="commands"&&s.jsx(M,{kind:"commands"})]}),n]})}const Ra=Object.freeze(Object.defineProperty({__proto__:null,PlaybooksPage:ka},Symbol.toStringTag,{value:"Module"}));export{ka as P,_a as a,Ea as b,xa as c,Ta as d,Ra as e,Ia as f,re as i,Aa as p,o as s};
