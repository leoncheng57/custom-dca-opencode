...
`,On=["user","assistant","tool","note"],Un=/^##[ \t]+([a-z]+)(?:[ \t]+—[ \t]*(.*))?[ \t]*$/,jn=/^[ \t]{0,3}(`{3,}|~{3,})(.*)$/;function qn(e){return On.includes(e)}function Ln(e){const n=[];let t=null,a=null;for(const i of e.split(`
`)){const h=i.match(jn);if(h){const[,c,d]=h;a===null?a=c:c[0]===a[0]&&c.length>=a.length&&d.trim()===""&&(a=null),t==null||t.lines.push(i);continue}const r=a===null?i.match(Un):null;if(r){const[,c,d]=r;if(!qn(c))return null;t={role:c,label:(d==null?void 0:d.trim())||void 0,lines:[]},n.push(t);continue}if(t){t.lines.push(i);continue}if(i.trim()!=="")return null}return n}function Mn(e){const{data:n,content:t}=D(e),a=(n.title??"").trim(),i=(n.trigger??"").trim(),h=(n.caveat??"").trim();if(a===""||i===""||h==="")return null;const r=Ln($(t));if(r===null||r.length===0||r[0].role!=="user")return null;const c=r.map(d=>({...d,body:d.lines.join(`
`).trim()})).filter(d=>d.body!=="").map(({role:d,label:u,body:l})=>u===void 0?{role:d,body:l}:{role:d,label:u,body:l});return c.length===0?null:{title:a,trigger:i,caveat:h,turns:c}}function H(e){const n=new Map;for(const[t,a]of Object.entries(e)){const i=P(t),h=i===""?null:Mn(a);h&&n.set(i,h)}return n}const Fn=Object.assign({"../../agent-skills/skills/ascii-diagrams/SKILL.md":Re,"../../agent-skills/skills/background-subagent/SKILL.md":Ae,"../../agent-skills/skills/build-waves/SKILL.md":Se,"../../agent-skills/skills/cite-file-lines/SKILL.md":Ce,"../../agent-skills/skills/deep-research-subagents/SKILL.md":Ne,"../../agent-skills/skills/docs-and-diagram-tooling/SKILL.md":De,"../../agent-skills/skills/duck-mode/SKILL.md":Pe,"../../agent-skills/skills/grill-me/SKILL.md":Oe,"../../agent-skills/skills/human-verification-steps/SKILL.md":Ue,"../../agent-skills/skills/manager-children/SKILL.md":je,"../../agent-skills/skills/native-worktree-subagents/SKILL.md":qe,"../../agent-skills/skills/parallel-research-handoff/SKILL.md":Le,"../../agent-skills/skills/red-team-this/SKILL.md":Me,"../../agent-skills/skills/session-handoff/SKILL.md":Fe,"../../agent-skills/skills/worktree-up/SKILL.md":We}),Wn=Object.assign({"../../agent-skills/skills/ascii-diagrams/SIMULATION.md":$e,"../../agent-skills/skills/background-subagent/SIMULATION.md":Be,"../../agent-skills/skills/build-waves/SIMULATION.md":Ge,"../../agent-skills/skills/deep-research-subagents/SIMULATION.md":He,"../../agent-skills/skills/docs-and-diagram-tooling/SIMULATION.md":Ve,"../../agent-skills/skills/duck-mode/SIMULATION.md":Ke,"../../agent-skills/skills/grill-me/SIMULATION.md":ze,"../../agent-skills/skills/human-verification-steps/SIMULATION.md":Ye,"../../agent-skills/skills/manager-children/SIMULATION.md":Xe,"../../agent-skills/skills/parallel-research-handoff/SIMULATION.md":Qe,"../../agent-skills/skills/red-team-this/SIMULATION.md":Ze,"../../agent-skills/skills/session-handoff/SIMULATION.md":Je,"../../agent-skills/skills/worktree-up/SIMULATION.md":en}),$n=Object.assign({"../../agent-skills/commands/background.md":nn,"../../agent-skills/commands/build-waves.md":tn,"../../agent-skills/commands/cite-file-lines.md":an,"../../agent-skills/commands/deep-research.md":sn,"../../agent-skills/commands/diagram.md":on,"../../agent-skills/commands/docs-preview.md":rn,"../../agent-skills/commands/duck-mode.md":ln,"../../agent-skills/commands/grill-me.md":dn,"../../agent-skills/commands/handoff.md":hn,"../../agent-skills/commands/manager-children.md":cn,"../../agent-skills/commands/native-worktree-subagents.md":un,"../../agent-skills/commands/red-team.md":pn,"../../agent-skills/commands/research-handoff.md":mn,"../../agent-skills/commands/session-handoff.md":gn,"../../agent-skills/commands/standup.md":fn,"../../agent-skills/commands/verify.md":wn,"../../agent-skills/commands/worktree-up.md":bn}),Bn=Object.assign({"../../agent-skills/command-simulations/background.md":yn,"../../agent-skills/command-simulations/build-waves.md":kn,"../../agent-skills/command-simulations/deep-research.md":vn,"../../agent-skills/command-simulations/diagram.md":xn,"../../agent-skills/command-simulations/docs-preview.md":Tn,"../../agent-skills/command-simulations/duck-mode.md":_n,"../../agent-skills/command-simulations/grill-me.md":In,"../../agent-skills/command-simulations/handoff.md":En,"../../agent-skills/command-simulations/manager-children.md":Rn,"../../agent-skills/command-simulations/red-team.md":An,"../../agent-skills/command-simulations/research-handoff.md":Sn,"../../agent-skills/command-simulations/session-handoff.md":Cn,"../../agent-skills/command-simulations/standup.md":Nn,"../../agent-skills/command-simulations/verify.md":Dn,"../../agent-skills/command-simulations/worktree-up.md":Pn});function Gn(e){return Object.fromEntries(Object.entries(e).map(([n,t])=>{var i;return[`commands/${((i=n.split("/").pop())==null?void 0:i.replace(/\.md$/u,""))??""}/SIMULATION.md`,t]}))}const x=_e(Fn,H(Wn)),R=de($n,{skillNames:new Set(x.map(e=>e.name)),simulations:H(Gn(Bn))});function ka(e){return x.find(n=>n.name===e)}function va(e){return R.find(n=>n.name===e)}function xa(e){return R.find(n=>n.relatedSkills.length===1&&n.relatedSkills[0]===e)}const Hn="https://github.com/leoncheng57/custom-dca-opencode",_=`${Hn}/blob/main/agent-skills`,Ta={skill:e=>`${_}/skills/${e}/SKILL.md`,skillSimulation:e=>`${_}/skills/${e}/SIMULATION.md`,command:e=>`${_}/commands/${e}.md`,commandSimulation:e=>`${_}/command-simulations/${e}.md`},Vn="_page_1680g_1",Kn="_content_1680g_8",zn="_wipWarning_1680g_14",Yn="_eyebrow_1680g_16",Xn="_type_1680g_16",Qn="_count_1680g_16",Zn="_filterLabel_1680g_16",Jn="_filterInput_1680g_16",et="_tag_1680g_16",nt="_meta_1680g_16",tt="_source_1680g_16",at="_terminal_1680g_16",st="_methodScope_1680g_16",ot="_hero_1680g_20",it="_modalTitle_1680g_37",rt="_cardTitle_1680g_37",lt="_sectionTitle_1680g_37",dt="_lede_1680g_42",ht="_typeStats_1680g_44",ct="_typeStat_1680g_44",ut="_catalog_1680g_49",pt="_catalogHead_1680g_50",mt="_filter_1680g_16",gt="_clear_1680g_57",ft="_tab_1680g_58",wt="_cardLink_1680g_58",bt="_tabs_1680g_60",yt="_tags_1680g_60",kt="_tabActive_1680g_64",vt="_grid_1680g_68",xt="_card_1680g_37",Tt="_cardTop_1680g_70",_t="_cardCopy_1680g_71",It="_cardTags_1680g_71",Et="_empty_1680g_72",Rt="_locations_1680g_74",At="_tableWrap_1680g_74",St="_table_1680g_74",Ct="_dialog_1680g_76",Nt="_dialogBody_1680g_77",Dt="_close_1680g_77",Pt="_modalHead_1680g_78",Ot="_modalDescription_1680g_78",Ut="_route_1680g_78",jt="_detailGrid_1680g_79",qt="_side_1680g_79",Lt="_note_1680g_79",Mt="_terminalBar_1680g_81",Ft="_light_1680g_81",Wt="_terminalPath_1680g_81",$t="_terminalSource_1680g_81",Bt="_terminalTurns_1680g_81",Gt="_turn_1680g_81",Ht="_turnRole_1680g_81",Vt="_turnAssistant_1680g_81",Kt="_turnTool_1680g_81",zt="_turnNote_1680g_81",Yt="_terminalControls_1680g_81",Xt="_terminalButton_1680g_81",Qt="_terminalButtonPrimary_1680g_81",Zt="_terminalStatus_1680g_81",Jt="_progress_1680g_81",ea="_disclosures_1680g_83",na="_disclosure_1680g_83",ta="_disclosureMeta_1680g_83",aa="_disclosureBody_1680g_83",sa="_descriptionPanel_1680g_83",oa="_descriptionBar_1680g_83",ia="_descriptionBody_1680g_83",ra="_relation_1680g_83",la="_method_1680g_16",da="_methodHead_1680g_83",ha="_methodCopy_1680g_83",ca="_command_1680g_83",ua="_notFound_1680g_83",o={page:Vn,content:Kn,wipWarning:zn,eyebrow:Yn,type:Xn,count:Qn,filterLabel:Zn,filterInput:Jn,tag:et,meta:nt,source:tt,terminal:at,methodScope:st,hero:ot,modalTitle:it,cardTitle:rt,sectionTitle:lt,lede:dt,typeStats:ht,typeStat:ct,catalog:ut,catalogHead:pt,filter:mt,clear:gt,tab:ft,cardLink:wt,tabs:bt,tags:yt,tabActive:kt,grid:vt,card:xt,cardTop:Tt,cardCopy:_t,cardTags:It,empty:Et,locations:Rt,tableWrap:At,table:St,dialog:Ct,dialogBody:Nt,close:Dt,modalHead:Pt,modalDescription:Ot,route:Ut,detailGrid:jt,side:qt,note:Lt,terminalBar:Mt,light:Ft,terminalPath:Wt,terminalSource:$t,terminalTurns:Bt,turn:Gt,turnRole:Ht,turnAssistant:Vt,turnTool:Kt,turnNote:zt,terminalControls:Yt,terminalButton:Xt,terminalButtonPrimary:Qt,terminalStatus:Zt,progress:Jt,disclosures:ea,disclosure:na,disclosureMeta:ta,disclosureBody:aa,descriptionPanel:sa,descriptionBar:oa,descriptionBody:ia,relation:ra,method:la,methodHead:da,methodCopy:ha,command:ca,notFound:ua};function pa({skill:e,onTag:n}){return s.jsxs("article",{className:o.card,"data-testid":"opencode-playbook-skill-card",children:[s.jsxs("div",{className:o.cardTop,children:[s.jsx("span",{className:o.type,children:"Skill"}),s.jsxs("span",{className:o.meta,children:[e.readingTimeMinutes," min"]})]}),s.jsx("h2",{className:o.cardTitle,children:e.title}),s.jsx("p",{className:o.cardCopy,children:e.summary}),s.jsx("div",{className:o.cardTags,children:e.tags.map(t=>s.jsxs("button",{className:o.tag,"data-testid":"opencode-playbook-tag",onClick:()=>n(t),type:"button",children:["#",t]},t))}),s.jsx(N,{className:o.cardLink,"data-testid":`opencode-playbook-skill-${e.name}`,to:`/playbooks/skills/${e.name}`,children:"Read playbook →"})]})}function ma({command:e}){return s.jsxs("article",{className:o.card,"data-testid":"opencode-playbook-command-card",children:[s.jsxs("div",{className:o.cardTop,children:[s.jsx("span",{className:o.type,children:"Command"}),s.jsx("span",{className:o.meta,children:e.subtask?"subtask":"session"})]}),s.jsx("h2",{className:o.cardTitle,children:re(e.name,e.takesArguments)}),s.jsx("p",{className:o.cardCopy,children:e.description}),s.jsxs("div",{className:o.cardTags,children:[e.runsShell&&s.jsx("span",{children:"shell input"}),e.relatedSkills.map(n=>s.jsx("span",{children:n},n))]}),s.jsx(N,{className:o.cardLink,"data-testid":`opencode-playbook-command-${e.name}`,to:`/playbooks/commands/${e.name}`,children:"Read command →"})]})}const ga=[{kind:"all",label:"All",href:"/playbooks"},{kind:"skills",label:"Skills",href:"/playbooks/skills"},{kind:"commands",label:"Commands",href:"/playbooks/commands"}];function M({kind:e}){const n=e==="skills"?me:pe;return s.jsxs("section",{className:o.locations,"aria-labelledby":`${e}-locations-heading`,children:[s.jsx("div",{className:o.eyebrow,children:"Install locations"}),s.jsxs("h2",{className:o.sectionTitle,id:`${e}-locations-heading`,children:["Where ",e," live"]}),s.jsx("p",{children:e==="skills"?"Skills are portable directories read by several agent families. Global paths apply everywhere; project paths travel with one repository.":"Commands are individual OpenCode markdown files. They cost no context until a human invokes them."}),s.jsx("div",{className:o.tableWrap,children:s.jsxs("table",{className:o.table,children:[s.jsx("thead",{children:s.jsxs("tr",{children:[s.jsx("th",{scope:"col",children:"Path"}),s.jsx("th",{scope:"col",children:"Scope"}),s.jsx("th",{scope:"col",children:"Read by"})]})}),s.jsx("tbody",{children:n.map(t=>s.jsxs("tr",{children:[s.jsx("th",{scope:"row",children:t.path}),s.jsx("td",{children:t.scope}),s.jsxs("td",{children:[t.readBy,s.jsx("span",{children:t.note})]})]},t.path))})]})})]})}function fa({kind:e="all",detail:n}){const[t,a]=y.useState(""),i=y.useRef(null),h=y.useMemo(()=>e==="commands"?[]:Ie(x,t),[e,t]),r=y.useMemo(()=>e==="skills"?[]:he(R,t),[e,t]),c=y.useMemo(()=>Ee(x),[]),d=h.length+r.length,u=l=>{var f;a(l),(f=i.current)==null||f.focus()};return s.jsxs("main",{className:o.page,"data-testid":"opencode-playbooks",children:[s.jsxs("div",{className:o.content,children:[s.jsx(K,{className:o.wipWarning,"data-testid":"opencode-playbooks-wip-warning",variant:"warning",children:"Playbooks is still work in progress and its UI/UX may contain bugs."}),s.jsxs("header",{className:o.hero,children:[s.jsxs("div",{children:[s.jsx("div",{className:o.eyebrow,children:"Repository-owned agent procedures"}),s.jsx("h1",{children:"Repeatable ways to work with an agent."}),s.jsx("p",{className:o.lede,children:"Skills are selected by the model. Commands are invoked by a human. Guided workflows can join them here later without turning one content type into the whole product."})]}),s.jsxs("aside",{className:o.typeStats,"aria-label":"Playbook types",children:[s.jsxs("div",{className:o.typeStat,children:[s.jsx("strong",{children:x.length}),s.jsx("span",{children:"Skills"})]}),s.jsxs("div",{className:o.typeStat,children:[s.jsx("strong",{children:R.length}),s.jsx("span",{children:"Commands"})]}),s.jsxs("div",{className:o.typeStat,children:[s.jsx("strong",{children:"Next"}),s.jsx("span",{children:"Workflows"})]})]})]}),s.jsxs("section",{className:o.catalog,"aria-labelledby":"playbook-catalog-heading",children:[s.jsxs("div",{className:o.catalogHead,children:[s.jsxs("div",{children:[s.jsx("div",{className:o.eyebrow,children:"Catalogue"}),s.jsxs("h2",{className:o.sectionTitle,id:"playbook-catalog-heading",children:[d," matching playbooks ",s.jsx("span",{className:o.count,children:e})]})]}),s.jsxs("label",{className:o.filter,children:[s.jsx(z,{"aria-hidden":"true",size:14}),s.jsx("span",{className:o.filterLabel,children:"filter"}),s.jsx("input",{className:o.filterInput,"data-testid":"opencode-playbook-filter",onChange:l=>a(l.target.value),placeholder:"name, tag, or trigger phrase",ref:i,type:"search",value:t}),t&&s.jsx("button",{"aria-label":"Clear filter",className:o.clear,onClick:()=>{var l;a(""),(l=i.current)==null||l.focus()},type:"button",children:"×"})]})]}),s.jsx("nav",{className:o.tabs,"aria-label":"Playbook types",children:ga.map(l=>s.jsx(N,{className:`${o.tab} ${l.kind===e?o.tabActive:""}`,to:l.href,children:l.label},l.kind))}),e!=="commands"&&s.jsxs("div",{className:o.tags,children:[s.jsx("span",{children:"try:"}),c.map(l=>s.jsxs("button",{className:o.tag,onClick:()=>u(l),type:"button",children:["#",l]},l))]}),d?s.jsxs("div",{className:o.grid,children:[h.map(l=>s.jsx(pa,{onTag:u,skill:l},l.name)),r.map(l=>s.jsx(ma,{command:l},l.name))]}):s.jsxs("p",{className:o.empty,children:["No playbook matches ",s.jsx("code",{children:t.trim()}),"."]})]}),e==="skills"&&s.jsx(M,{kind:"skills"}),e==="commands"&&s.jsx(M,{kind:"commands"})]}),n]})}const _a=Object.freeze(Object.defineProperty({__proto__:null,PlaybooksPage:fa},Symbol.toStringTag,{value:"Module"}));export{fa as P,ka as a,xa as b,ba as c,ya as d,_a as e,va as f,re as i,Ta as p,o as s};
